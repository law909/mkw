 ...
 */
class TermekMenuFa extends \Entities\TermekMenuFa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekMenuFa' . "\0" . 'id', '' . "\0" . 'Entities\\TermekMenuFa' . "\0" . 'created', '' . "\0" . 'Entities\\TermekMenuFa' . "\0" . 'lastmod', '' . "\0" . 'Entities\\TermekMenuFa' . "\0" . 'nev', '' . "\0" . 'Entities\\TermekMenuFa' . "\0" . 'sorrend'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekMenuFa $proxy) {
