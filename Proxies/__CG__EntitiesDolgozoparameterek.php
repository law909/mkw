 ...
 */
class Dolgozoparameterek extends \Entities\Dolgozoparameterek implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Dolgozoparameterek' . "\0" . 'id', '' . "\0" . 'Entities\\Dolgozoparameterek' . "\0" . 'dolgozo', '' . "\0" . 'Entities\\Dolgozoparameterek' . "\0" . 'par', '' . "\0" . 'Entities\\Dolgozoparameterek' . "\0" . 'ertek'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dolgozoparameterek $proxy) {
    ...
    public function getPar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPar', []);

        return parent::getPar();
    }
    ...
    public function setPar($par)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPar', [$par]);

        return parent::setPar($par);
    }
