 ...
 */
class Unnepnap extends \Entities\Unnepnap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Unnepnap' . "\0" . 'id', '' . "\0" . 'Entities\\Unnepnap' . "\0" . 'datum'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Unnepnap $proxy) {
