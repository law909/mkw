 ...
 */
class ME extends \Entities\ME implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\ME' . "\0" . 'id', '' . "\0" . 'Entities\\ME' . "\0" . 'nev', '' . "\0" . 'Entities\\ME' . "\0" . 'navtipus'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ME $proxy) {
