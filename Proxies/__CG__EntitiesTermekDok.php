 ...
 */
class TermekDok extends \Entities\TermekDok implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekDok' . "\0" . 'termek'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekDok $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setTermek(\Entities\Termek $r)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTermek', [$r]);

        return parent::setTermek($r);
    }
