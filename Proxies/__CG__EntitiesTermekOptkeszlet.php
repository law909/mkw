 ...
 */
class TermekOptkeszlet extends \Entities\TermekOptkeszlet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekOptkeszlet' . "\0" . 'id', '' . "\0" . 'Entities\\TermekOptkeszlet' . "\0" . 'created', '' . "\0" . 'Entities\\TermekOptkeszlet' . "\0" . 'lastmod', '' . "\0" . 'Entities\\TermekOptkeszlet' . "\0" . 'termek', '' . "\0" . 'Entities\\TermekOptkeszlet' . "\0" . 'raktar', '' . "\0" . 'Entities\\TermekOptkeszlet' . "\0" . 'optkeszlet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekOptkeszlet $proxy) {
