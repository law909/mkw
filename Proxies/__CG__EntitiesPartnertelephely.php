 ...
 */
class Partnertelephely extends \Entities\Partnertelephely implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'id', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'partner', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'nev', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'irszam', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'varos', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'utca', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'orszag', '' . "\0" . 'Entities\\Partnertelephely' . "\0" . 'migrid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Partnertelephely $proxy) {
    ...
    public function setOrszag($orszag)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrszag', [$orszag]);

        return parent::setOrszag($orszag);
    }
    ...
    public function getNevCim()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNevCim', []);

        return parent::getNevCim();
    }
