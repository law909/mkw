 ...
 */
class Csk extends \Entities\Csk implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Csk' . "\0" . 'id', '' . "\0" . 'Entities\\Csk' . "\0" . 'nev', '' . "\0" . 'Entities\\Csk' . "\0" . 'ertek', '' . "\0" . 'Entities\\Csk' . "\0" . 'migrid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Csk $proxy) {
