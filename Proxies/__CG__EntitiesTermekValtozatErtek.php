 ...
 */
class TermekValtozatErtek extends \Entities\TermekValtozatErtek implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekValtozatErtek' . "\0" . 'id', '' . "\0" . 'Entities\\TermekValtozatErtek' . "\0" . 'ertek', '' . "\0" . 'Entities\\TermekValtozatErtek' . "\0" . 'adattipus', '' . "\0" . 'Entities\\TermekValtozatErtek' . "\0" . 'wcid', '' . "\0" . 'Entities\\TermekValtozatErtek' . "\0" . 'wcdate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekValtozatErtek $proxy) {
    ...
    public function getAdatTipus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdatTipus', []);

        return parent::getAdatTipus();
    }
    ...
    public function getAdatTipusId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdatTipusId', []);

        return parent::getAdatTipusId();
    }
    ...
    public function getAdatTipusNev()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdatTipusNev', []);

        return parent::getAdatTipusNev();
    }
    ...
    public function setAdatTipus($at)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdatTipus', [$at]);

        return parent::setAdatTipus($at);
    }
