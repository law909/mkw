 ...
 */
class Menucsoport extends \Entities\Menucsoport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Menucsoport' . "\0" . 'id', '' . "\0" . 'Entities\\Menucsoport' . "\0" . 'nev', '' . "\0" . 'Entities\\Menucsoport' . "\0" . 'jogosultsag', '' . "\0" . 'Entities\\Menucsoport' . "\0" . 'lathato', '' . "\0" . 'Entities\\Menucsoport' . "\0" . 'sorrend'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Menucsoport $proxy) {
