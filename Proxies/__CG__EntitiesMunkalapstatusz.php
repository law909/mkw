 ...
 */
class Munkalapstatusz extends \Entities\Munkalapstatusz implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Munkalapstatusz' . "\0" . 'id', '' . "\0" . 'Entities\\Munkalapstatusz' . "\0" . 'kod', '' . "\0" . 'Entities\\Munkalapstatusz' . "\0" . 'nev', '' . "\0" . 'Entities\\Munkalapstatusz' . "\0" . 'sorrend', '' . "\0" . 'Entities\\Munkalapstatusz' . "\0" . 'emailtemplate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Munkalapstatusz $proxy) {
