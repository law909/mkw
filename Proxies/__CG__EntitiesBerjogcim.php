 ...
 */
class Berjogcim extends \Entities\Berjogcim implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Berjogcim' . "\0" . 'id', '' . "\0" . 'Entities\\Berjogcim' . "\0" . 'nev', '' . "\0" . 'Entities\\Berjogcim' . "\0" . 'inaktiv'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Berjogcim $proxy) {
