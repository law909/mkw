 ...
 */
class TermekMinboltikeszlet extends \Entities\TermekMinboltikeszlet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekMinboltikeszlet' . "\0" . 'id', '' . "\0" . 'Entities\\TermekMinboltikeszlet' . "\0" . 'created', '' . "\0" . 'Entities\\TermekMinboltikeszlet' . "\0" . 'lastmod', '' . "\0" . 'Entities\\TermekMinboltikeszlet' . "\0" . 'termek', '' . "\0" . 'Entities\\TermekMinboltikeszlet' . "\0" . 'raktar', '' . "\0" . 'Entities\\TermekMinboltikeszlet' . "\0" . 'minboltikeszlet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekMinboltikeszlet $proxy) {
