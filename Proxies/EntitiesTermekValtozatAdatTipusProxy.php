 ...
 */
class EntitiesTermekValtozatAdatTipusProxy extends \Entities\TermekValtozatAdatTipus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nev', 'valtozatok1', 'valtozatok2');
    }
