 ...
 */
class Fiforeteg extends \Entities\Fiforeteg implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'id', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'raktar', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'termek', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'termekvaltozat', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'bebizonylatfej', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'bebizonylattetel', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'teljesites', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'mennyiseg', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'egysegar', '' . "\0" . 'Entities\\Fiforeteg' . "\0" . 'becsult'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Fiforeteg $proxy) {
    ...
    public function setBebizonylatfej($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBebizonylatfej', [$val]);

        return parent::setBebizonylatfej($val);
    }
    ...
    public function setBebizonylattetel($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBebizonylattetel', [$val]);

        return parent::setBebizonylattetel($val);
    }
    ...
    public function setTeljesites($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTeljesites', [$val]);

        return parent::setTeljesites($val);
    }
