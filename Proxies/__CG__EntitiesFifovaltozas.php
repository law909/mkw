 ...
 */
class Fifovaltozas extends \Entities\Fifovaltozas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Fifovaltozas' . "\0" . 'id', '' . "\0" . 'Entities\\Fifovaltozas' . "\0" . 'raktar_id', '' . "\0" . 'Entities\\Fifovaltozas' . "\0" . 'termek_id', '' . "\0" . 'Entities\\Fifovaltozas' . "\0" . 'termekvaltozat_id', '' . "\0" . 'Entities\\Fifovaltozas' . "\0" . 'created'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Fifovaltozas $proxy) {
