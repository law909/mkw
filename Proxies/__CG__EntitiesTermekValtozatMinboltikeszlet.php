 ...
 */
class TermekValtozatMinboltikeszlet extends \Entities\TermekValtozatMinboltikeszlet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekValtozatMinboltikeszlet' . "\0" . 'id', '' . "\0" . 'Entities\\TermekValtozatMinboltikeszlet' . "\0" . 'created', '' . "\0" . 'Entities\\TermekValtozatMinboltikeszlet' . "\0" . 'lastmod', '' . "\0" . 'Entities\\TermekValtozatMinboltikeszlet' . "\0" . 'termekvaltozat', '' . "\0" . 'Entities\\TermekValtozatMinboltikeszlet' . "\0" . 'raktar', '' . "\0" . 'Entities\\TermekValtozatMinboltikeszlet' . "\0" . 'minboltikeszlet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekValtozatMinboltikeszlet $proxy) {
