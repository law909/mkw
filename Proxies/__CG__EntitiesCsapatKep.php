 ...
 */
class CsapatKep extends \Entities\CsapatKep implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'id', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'created', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'lastmod', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'csapat', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'url', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'leiras', '' . "\0" . 'Entities\\CsapatKep' . "\0" . 'rejtett'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CsapatKep $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCsapat(\Entities\Csapat $csapat)
    {
    ...
    public function removeCsapat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCsapat', []);

        return parent::removeCsapat();
    }
