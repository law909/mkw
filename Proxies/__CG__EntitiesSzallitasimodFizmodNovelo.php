 ...
 */
class SzallitasimodFizmodNovelo extends \Entities\SzallitasimodFizmodNovelo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SzallitasimodFizmodNovelo $proxy) {
