...
class Szallitasimod extends \Entities\Szallitasimod implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'id', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'nev', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'webes', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'vanszallitasiktg', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'leiras', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'fizmodok', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'bizonylatfejek', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'sorrend', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'partnerek', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'hatarok', 'locale', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'translations', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'terminaltipus', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'webes2', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'webes3', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'webes4', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'termek', '' . "\0" . 'Entities\\Szallitasimod' . "\0" . 'wcid'];
        }
    ...
    public function getWebes4()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWebes4', []);

        return parent::getWebes4();
    }
    ...
    public function setWebes4($webes4)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWebes4', [$webes4]);

        return parent::setWebes4($webes4);
    }
