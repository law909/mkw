...
class Termek extends \Entities\Termek implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Termek' . "\0" . 'id', '' . "\0" . 'Entities\\Termek' . "\0" . 'created', '' . "\0" . 'Entities\\Termek' . "\0" . 'lastmod', '' . "\0" . 'Entities\\Termek' . "\0" . 'contentmod', '' . "\0" . 'Entities\\Termek' . "\0" . 'idegenkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'nev', '' . "\0" . 'Entities\\Termek' . "\0" . 'nev_l1', '' . "\0" . 'Entities\\Termek' . "\0" . 'kiirtnev', '' . "\0" . 'Entities\\Termek' . "\0" . 'me', '' . "\0" . 'Entities\\Termek' . "\0" . 'kiszereles', '' . "\0" . 'Entities\\Termek' . "\0" . 'vtsz', '' . "\0" . 'Entities\\Termek' . "\0" . 'afa', '' . "\0" . 'Entities\\Termek' . "\0" . 'mekod', '' . "\0" . 'Entities\\Termek' . "\0" . 'cimkek', '' . "\0" . 'Entities\\Termek' . "\0" . 'kapcsolodokoltsegek', '' . "\0" . 'Entities\\Termek' . "\0" . 'cimkenevek', '' . "\0" . 'Entities\\Termek' . "\0" . 'blogposztok', '' . "\0" . 'Entities\\Termek' . "\0" . 'cikkszam', '' . "\0" . 'Entities\\Termek' . "\0" . 'idegencikkszam', '' . "\0" . 'Entities\\Termek' . "\0" . 'vonalkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'leiras', '' . "\0" . 'Entities\\Termek' . "\0" . 'leiras_l1', '' . "\0" . 'Entities\\Termek' . "\0" . 'rovidleiras', '' . "\0" . 'Entities\\Termek' . "\0" . 'rovidleiras_l1', '' . "\0" . 'Entities\\Termek' . "\0" . 'oldalcim', '' . "\0" . 'Entities\\Termek' . "\0" . 'oldalcim_l1', '' . "\0" . 'Entities\\Termek' . "\0" . 'seodescription', '' . "\0" . 'Entities\\Termek' . "\0" . 'seokeywords', '' . "\0" . 'Entities\\Termek' . "\0" . 'unasid', '' . "\0" . 'Entities\\Termek' . "\0" . 'unasalaptipus', '' . "\0" . 'Entities\\Termek' . "\0" . 'slug', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato2', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato3', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato4', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato5', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato6', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato7', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato8', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato9', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato10', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato11', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato12', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato13', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato14', '' . "\0" . 'Entities\\Termek' . "\0" . 'lathato15', '' . "\0" . 'Entities\\Termek' . "\0" . 'hozzaszolas', '' . "\0" . 'Entities\\Termek' . "\0" . 'ajanlott', '' . "\0" . 'Entities\\Termek' . "\0" . 'kiemelt', '' . "\0" . 'Entities\\Termek' . "\0" . 'mozgat', '' . "\0" . 'Entities\\Termek' . "\0" . 'inaktiv', '' . "\0" . 'Entities\\Termek' . "\0" . 'fuggoben', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekexportbanszerepel', '' . "\0" . 'Entities\\Termek' . "\0" . 'kellegyediazonosito', '' . "\0" . 'Entities\\Termek' . "\0" . 'hparany', '' . "\0" . 'Entities\\Termek' . "\0" . 'netto', '' . "\0" . 'Entities\\Termek' . "\0" . 'brutto', '' . "\0" . 'Entities\\Termek' . "\0" . 'akciosnetto', '' . "\0" . 'Entities\\Termek' . "\0" . 'akciosbrutto', '' . "\0" . 'Entities\\Termek' . "\0" . 'akciostart', '' . "\0" . 'Entities\\Termek' . "\0" . 'akciostop', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekfa1', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekfa1karkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekfa2', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekfa2karkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekfa3', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekfa3karkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekmenu1', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekmenu1karkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekmenu2', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekmenu2karkod', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekmenuk', '' . "\0" . 'Entities\\Termek' . "\0" . 'kepurl', '' . "\0" . 'Entities\\Termek' . "\0" . 'kepleiras', '' . "\0" . 'Entities\\Termek' . "\0" . 'szelesseg', '' . "\0" . 'Entities\\Termek' . "\0" . 'magassag', '' . "\0" . 'Entities\\Termek' . "\0" . 'hosszusag', '' . "\0" . 'Entities\\Termek' . "\0" . 'suly', '' . "\0" . 'Entities\\Termek' . "\0" . 'suruseg', '' . "\0" . 'Entities\\Termek' . "\0" . 'osszehajthato', '' . "\0" . 'Entities\\Termek' . "\0" . 'gyujto', '' . "\0" . 'Entities\\Termek' . "\0" . 'sordoboz', '' . "\0" . 'Entities\\Termek' . "\0" . 'bonthato', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekkepek', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekszinkepek', '' . "\0" . 'Entities\\Termek' . "\0" . 'valtozatok', '' . "\0" . 'Entities\\Termek' . "\0" . 'bizonylattetelek', '' . "\0" . 'Entities\\Termek' . "\0" . 'leltartetelek', '' . "\0" . 'Entities\\Termek' . "\0" . 'kosarak', '' . "\0" . 'Entities\\Termek' . "\0" . 'megtekintesdb', '' . "\0" . 'Entities\\Termek' . "\0" . 'megvasarlasdb', '' . "\0" . 'Entities\\Termek' . "\0" . 'nepszeruseg', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekkapcsolodok', '' . "\0" . 'Entities\\Termek' . "\0" . 'altermekkapcsolodok', '' . "\0" . 'Entities\\Termek' . "\0" . 'valtozatadattipus', '' . "\0" . 'Entities\\Termek' . "\0" . 'nemkaphato', '' . "\0" . 'Entities\\Termek' . "\0" . 'kifuto', '' . "\0" . 'Entities\\Termek' . "\0" . 'csomagpontbanemszallithato', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekertesitok', '' . "\0" . 'Entities\\Termek' . "\0" . 'gyarto', '' . "\0" . 'Entities\\Termek' . "\0" . 'szallitasiido', '' . "\0" . 'Entities\\Termek' . "\0" . 'szallitasiidostr', '' . "\0" . 'Entities\\Termek' . "\0" . 'regikepurl', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekarak', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekcsoport', '' . "\0" . 'Entities\\Termek' . "\0" . 'kozvetitett', '' . "\0" . 'Entities\\Termek' . "\0" . 'migrid', '' . "\0" . 'Entities\\Termek' . "\0" . 'egyprodukcios', '' . "\0" . 'Entities\\Termek' . "\0" . 'valutameszorzo', '' . "\0" . 'Entities\\Termek' . "\0" . 'jogaalkalom', '' . "\0" . 'Entities\\Termek' . "\0" . 'jogaervenyesseg', '' . "\0" . 'Entities\\Termek' . "\0" . 'jogaelszamolasalap', '' . "\0" . 'Entities\\Termek' . "\0" . 'jogaervenyessegnap', '' . "\0" . 'Entities\\Termek' . "\0" . 'eladhato', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekdokok', '' . "\0" . 'Entities\\Termek' . "\0" . 'minkeszlet', '' . "\0" . 'Entities\\Termek' . "\0" . 'optkeszlet', '' . "\0" . 'Entities\\Termek' . "\0" . 'garancia', '' . "\0" . 'Entities\\Termek' . "\0" . 'arukeresofanev', '' . "\0" . 'Entities\\Termek' . "\0" . 'termekertekelesek', '' . "\0" . 'Entities\\Termek' . "\0" . 'feltoltheto', '' . "\0" . 'Entities\\Termek' . "\0" . 'feltoltheto2', '' . "\0" . 'Entities\\Termek' . "\0" . 'feltoltheto3', '' . "\0" . 'Entities\\Termek' . "\0" . 'feltoltheto4', '' . "\0" . 'Entities\\Termek' . "\0" . 'feltoltheto5', '' . "\0" . 'Entities\\Termek' . "\0" . 'uj'];
        }
    ...
    public function getTermekmenuk()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekmenuk', []);

        return parent::getTermekmenuk();
    }

    /**
     * {@inheritDoc}
     */
    public function getTermekMenu(\Entities\TermekMenuFa $fa): ?\Entities\TermekMenu
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekMenu', [$fa]);

        return parent::getTermekMenu($fa);
    }

    /**
     * {@inheritDoc}
     */
    public function setTermekMenu(\Entities\TermekMenuFa $fa, ?\Entities\TermekMenu $node)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTermekMenu', [$fa, $node]);

        return parent::setTermekMenu($fa, $node);
    }
    ...
    public function getUnasid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnasid', []);

        return parent::getUnasid();
    }
    ...
    public function setUnasid($unasid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnasid', [$unasid]);

        return parent::setUnasid($unasid);
    }
    ...
    public function getUnasalaptipus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnasalaptipus', []);

        return parent::getUnasalaptipus();
    }
    ...
    public function setUnasalaptipus($unasalaptipus)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnasalaptipus', [$unasalaptipus]);

        return parent::setUnasalaptipus($unasalaptipus);
    }
    ...
    public function getKellegyediazonosito()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKellegyediazonosito', []);

        return parent::getKellegyediazonosito();
    }
    ...
    public function setKellegyediazonosito($kellegyediazonosito)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setKellegyediazonosito', [$kellegyediazonosito]);

        return parent::setKellegyediazonosito($kellegyediazonosito);
    }
    ...
    public function getAllKapcsolodokoltsegId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAllKapcsolodokoltsegId', []);

        return parent::getAllKapcsolodokoltsegId();
    }
    ...
    public function getTermekmenu2()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekmenu2', []);

        return parent::getTermekmenu2();
    }
    ...
    public function getTermekmenu2Nev()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekmenu2Nev', []);

        return parent::getTermekmenu2Nev();
    }
    ...
    public function getTermekmenu2Id()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekmenu2Id', []);

        return parent::getTermekmenu2Id();
    }
    ...
    public function getTermekmenu2Path()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekmenu2Path', []);

        return parent::getTermekmenu2Path();
    }
    ...
    public function setTermekmenu2($termekmenu)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTermekmenu2', [$termekmenu]);

        return parent::setTermekmenu2($termekmenu);
    }
    ...
    public function getTermekSzinKepek()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekSzinKepek', []);

        return parent::getTermekSzinKepek();
    }

    /**
     * {@inheritDoc}
     */
    public function addTermekSzinKep(\Entities\TermekSzinKep $kep)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTermekSzinKep', [$kep]);

        return parent::addTermekSzinKep($kep);
    }

    /**
     * {@inheritDoc}
     */
    public function removeTermekSzinKep(\Entities\TermekSzinKep $kep)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTermekSzinKep', [$kep]);

        return parent::removeTermekSzinKep($kep);
    }
    ...
    public function getContentmod()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContentmod', []);

        return parent::getContentmod();
    }
    ...
    public function setContentmod($adat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContentmod', [$adat]);

        return parent::setContentmod($adat);
    }
    ...
    public function getGyartoKedvezmeny($partner = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGyartoKedvezmeny', [$partner]);

        return parent::getGyartoKedvezmeny($partner);
    }
    ...
    public function getKifuto()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKifuto', []);

        return parent::getKifuto();
    }
    ...
    public function setKifuto($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setKifuto', [$val]);

        return parent::setKifuto($val);
    }
    ...
    public function getCsomagpontbanemszallithato()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCsomagpontbanemszallithato', []);

        return parent::getCsomagpontbanemszallithato();
    }
    ...
    public function setCsomagpontbanemszallithato($d)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCsomagpontbanemszallithato', [$d]);

        return parent::setCsomagpontbanemszallithato($d);
    }
    ...
    public function getSzallitasiidostr()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSzallitasiidostr', []);

        return parent::getSzallitasiidostr();
    }
    ...
    public function setSzallitasiidostr($adat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSzallitasiidostr', [$adat]);

        return parent::setSzallitasiidostr($adat);
    }
    ...
    public function isWebshopVisible(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isWebshopVisible', []);

        return parent::isWebshopVisible();
    }
    ...
    public function getMinkeszlet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMinkeszlet', []);

        return parent::getMinkeszlet();
    }
    ...
    public function calcMinkeszlet($raktarid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'calcMinkeszlet', [$raktarid]);

        return parent::calcMinkeszlet($raktarid);
    }
    ...
    public function setMinkeszlet($minkeszlet)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMinkeszlet', [$minkeszlet]);

        return parent::setMinkeszlet($minkeszlet);
    }
    ...
    public function getOptkeszlet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOptkeszlet', []);

        return parent::getOptkeszlet();
    }
    ...
    public function setOptkeszlet($optkeszlet)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOptkeszlet', [$optkeszlet]);

        return parent::setOptkeszlet($optkeszlet);
    }
    ...
    public function getNFeltoltheto($n)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNFeltoltheto', [$n]);

        return parent::getNFeltoltheto($n);
    }
    ...
    public function getFeltoltheto()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFeltoltheto', []);

        return parent::getFeltoltheto();
    }
    ...
    public function setFeltoltheto($feltoltheto): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFeltoltheto', [$feltoltheto]);

        parent::setFeltoltheto($feltoltheto);
    }
    ...
    public function getFeltoltheto2()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFeltoltheto2', []);

        return parent::getFeltoltheto2();
    }
    ...
    public function setFeltoltheto2($feltoltheto2): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFeltoltheto2', [$feltoltheto2]);

        parent::setFeltoltheto2($feltoltheto2);
    }
    ...
    public function getFeltoltheto3()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFeltoltheto3', []);

        return parent::getFeltoltheto3();
    }
    ...
    public function setFeltoltheto3($feltoltheto3): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFeltoltheto3', [$feltoltheto3]);

        parent::setFeltoltheto3($feltoltheto3);
    }
    ...
    public function getFeltoltheto4()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFeltoltheto4', []);

        return parent::getFeltoltheto4();
    }
    ...
    public function setFeltoltheto4($feltoltheto4): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFeltoltheto4', [$feltoltheto4]);

        parent::setFeltoltheto4($feltoltheto4);
    }
    ...
    public function getFeltoltheto5()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFeltoltheto5', []);

        return parent::getFeltoltheto5();
    }
    ...
    public function setFeltoltheto5($feltoltheto5): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFeltoltheto5', [$feltoltheto5]);

        parent::setFeltoltheto5($feltoltheto5);
    }
    ...
    public function getUj()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUj', []);
    ...
    public function setUj($uj): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUj', [$uj]);
