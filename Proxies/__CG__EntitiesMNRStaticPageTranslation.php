 ...
 */
class MNRStaticPageTranslation extends \Entities\MNRStaticPageTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MNRStaticPageTranslation $proxy) {
