 ...
 */
class Apiconsumer extends \Entities\Apiconsumer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Apiconsumer $proxy) {
    ...
    public function getKulcs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKulcs', []);

        return parent::getKulcs();
    }
