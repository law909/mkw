 ...
 */
class Penztar extends \Entities\Penztar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Penztar' . "\0" . 'id', '' . "\0" . 'Entities\\Penztar' . "\0" . 'nev', '' . "\0" . 'Entities\\Penztar' . "\0" . 'valutanem', '' . "\0" . 'Entities\\Penztar' . "\0" . 'migrid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Penztar $proxy) {
