 ...
 */
class PartnerGyartoKedvezmeny extends \Entities\PartnerGyartoKedvezmeny implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\PartnerGyartoKedvezmeny' . "\0" . 'id', '' . "\0" . 'Entities\\PartnerGyartoKedvezmeny' . "\0" . 'created', '' . "\0" . 'Entities\\PartnerGyartoKedvezmeny' . "\0" . 'lastmod', '' . "\0" . 'Entities\\PartnerGyartoKedvezmeny' . "\0" . 'partner', '' . "\0" . 'Entities\\PartnerGyartoKedvezmeny' . "\0" . 'gyarto', '' . "\0" . 'Entities\\PartnerGyartoKedvezmeny' . "\0" . 'kedvezmeny'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartnerGyartoKedvezmeny $proxy) {
