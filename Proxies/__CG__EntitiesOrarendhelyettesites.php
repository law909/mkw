 ...
 */
class Orarendhelyettesites extends \Entities\Orarendhelyettesites implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'id', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'created', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'lastmod', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'datum', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'orarend', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'helyettesito', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'inaktiv', '' . "\0" . 'Entities\\Orarendhelyettesites' . "\0" . 'elmarad'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Orarendhelyettesites $proxy) {
    ...
    public function getOrarendNev()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrarendNev', []);

        return parent::getOrarendNev();
    }
    ...
    public function setOrarend($orarend)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrarend', [$orarend]);

        return parent::setOrarend($orarend);
    }
