 ...
 */
class BizonylattetelTranslation extends \Entities\BizonylattetelTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BizonylattetelTranslation $proxy) {
