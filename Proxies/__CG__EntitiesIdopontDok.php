 ...
 */
class IdopontDok extends \Entities\IdopontDok implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IdopontDok $proxy) {
    ...
    public function getIdopontNev()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdopontNev', []);

        return parent::getIdopontNev();
    }

    /**
     * {@inheritDoc}
     */
    public function setIdopont(\Entities\Idopont $r)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdopont', [$r]);

        return parent::setIdopont($r);
    }
    ...
    public function removeIdopont()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIdopont', []);

        return parent::removeIdopont();
    }
