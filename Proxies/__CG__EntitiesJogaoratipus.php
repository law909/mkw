 ...
 */
class Jogaoratipus extends \Entities\Jogaoratipus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Jogaoratipus $proxy) {
    ...
    public function getArnovelo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArnovelo', []);

        return parent::getArnovelo();
    }
