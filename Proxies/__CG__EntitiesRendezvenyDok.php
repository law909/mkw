 ...
 */
class RendezvenyDok extends \Entities\RendezvenyDok implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\RendezvenyDok' . "\0" . 'rendezveny'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RendezvenyDok $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setRendezveny(\Entities\Rendezveny $r)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRendezveny', [$r]);

        return parent::setRendezveny($r);
    }
