 ...
 */
class MNRLanding extends \Entities\MNRLanding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\MNRLanding' . "\0" . 'id', '' . "\0" . 'Entities\\MNRLanding' . "\0" . 'nev', '' . "\0" . 'Entities\\MNRLanding' . "\0" . 'kepurl', '' . "\0" . 'Entities\\MNRLanding' . "\0" . 'szlogen', 'locale', '' . "\0" . 'Entities\\MNRLanding' . "\0" . 'translations'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MNRLanding $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTranslation(\Entities\MNRLandingTranslation $t)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTranslation(\Entities\MNRLandingTranslation $t)
    {
