 ...
 */
class BizonylatfejTranslation extends \Entities\BizonylatfejTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BizonylatfejTranslation $proxy) {
