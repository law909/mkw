 ...
 */
class MNRNavigationTranslation extends \Entities\MNRNavigationTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MNRNavigationTranslation $proxy) {
