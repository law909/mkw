 ...
 */
class Irszam extends \Entities\Irszam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Irszam' . "\0" . 'id', '' . "\0" . 'Entities\\Irszam' . "\0" . 'szam', '' . "\0" . 'Entities\\Irszam' . "\0" . 'nev');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Irszam $proxy) {
    ...
    public function setSzam($szam)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSzam', array($szam));
