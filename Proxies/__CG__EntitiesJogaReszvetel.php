...
class JogaReszvetel extends \Entities\JogaReszvetel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setJogaberlet($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setJogaberlet', [$val]);

        return parent::setJogaberlet($val);
    }
    ...
    public function isTisztaznikell()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isTisztaznikell', []);

        return parent::isTisztaznikell();
    }
