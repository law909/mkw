...
class TermekFa extends \Entities\TermekFa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'gtnev', 'm1lchanged', 'm2lchanged', 'm3lchanged', 'm4lchanged', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'id', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'created', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lastmod', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'children', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'parent', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'nev', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'sorrend', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'slug', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'karkod', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'rovidleiras', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'leiras', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'leiras2', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'leiras3', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'menu1lathato', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'menu2lathato', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'menu3lathato', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'menu4lathato', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'oldalcim', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'seodescription', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'kepurl', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'kepleiras', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'termekek1', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'termekek2', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'termekek3', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'inaktiv', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'idegenkod', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'translations', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'locale', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato2', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato3', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato4', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato5', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato6', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato7', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato8', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato9', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato10', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato11', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato12', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato13', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato14', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'lathato15', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'arukeresoid', '' . "\0" . 'Entities\\TermekFa' . "\0" . 'sketchfabmodelid'];
        }
