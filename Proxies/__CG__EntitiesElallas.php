 ...
 */
class Elallas extends \Entities\Elallas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Elallas' . "\0" . 'id', '' . "\0" . 'Entities\\Elallas' . "\0" . 'created', '' . "\0" . 'Entities\\Elallas' . "\0" . 'lastmod', '' . "\0" . 'Entities\\Elallas' . "\0" . 'nev', '' . "\0" . 'Entities\\Elallas' . "\0" . 'email', '' . "\0" . 'Entities\\Elallas' . "\0" . 'bizonylat', '' . "\0" . 'Entities\\Elallas' . "\0" . 'szoveg', '' . "\0" . 'Entities\\Elallas' . "\0" . 'naplok'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Elallas $proxy) {
    ...
    public function getBizonylat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBizonylat', []);

        return parent::getBizonylat();
    }
    ...
    public function setBizonylat($bizonylat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBizonylat', [$bizonylat]);

        return parent::setBizonylat($bizonylat);
    }
    ...
    public function getNaplok()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNaplok', []);

        return parent::getNaplok();
    }

    /**
     * {@inheritDoc}
     */
    public function addNaplo(\Entities\Elallasnaplo $naplo)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addNaplo', [$naplo]);

        return parent::addNaplo($naplo);
    }
