 ...
 */
class MNRStatic extends \Entities\MNRStatic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'id', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'nev', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'kepurl', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'szlogen1', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'szlogen2', 'locale', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'mnrstaticpages', '' . "\0" . 'Entities\\MNRStatic' . "\0" . 'translations'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MNRStatic $proxy) {
    ...
    public function getMNRStaticPages()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMNRStaticPages', []);

        return parent::getMNRStaticPages();
    }

    /**
     * {@inheritDoc}
     */
    public function addMNRStaticPage(\Entities\MNRStaticPage $page)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMNRStaticPage', [$page]);

        return parent::addMNRStaticPage($page);
    }

    /**
     * {@inheritDoc}
     */
    public function removeMNRStaticPage(\Entities\MNRStaticPage $page)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMNRStaticPage', [$page]);

        return parent::removeMNRStaticPage($page);
    }
     ...
     * {@inheritDoc}
     */
    public function addTranslation(\Entities\MNRStaticTranslation $t)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTranslation(\Entities\MNRStaticTranslation $t)
    {
