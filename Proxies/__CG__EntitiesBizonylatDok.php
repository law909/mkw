 ...
 */
class BizonylatDok extends \Entities\BizonylatDok implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\BizonylatDok' . "\0" . 'bizonylat'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BizonylatDok $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setBizonylat(\Entities\Bizonylatfej $r)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBizonylat', [$r]);

        return parent::setBizonylat($r);
    }
    ...
    public function removeBizonylat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBizonylat', []);

        return parent::removeBizonylat();
    }
