 ...
 */
class Termekcimkekat extends \Entities\Termekcimkekat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Termekcimkekat' . "\0" . 'nev', '' . "\0" . 'Entities\\Termekcimkekat' . "\0" . 'slug', '' . "\0" . 'Entities\\Termekcimkekat' . "\0" . 'cimkek');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Termekcimkekat $proxy) {
