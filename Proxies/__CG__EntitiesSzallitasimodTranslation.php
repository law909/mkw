 ...
 */
class SzallitasimodTranslation extends \Entities\SzallitasimodTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SzallitasimodTranslation $proxy) {
