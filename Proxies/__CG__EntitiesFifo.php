...
class Fifo extends \Entities\Fifo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Fifo' . "\0" . 'id', '' . "\0" . 'Entities\\Fifo' . "\0" . 'raktar', '' . "\0" . 'Entities\\Fifo' . "\0" . 'termek', '' . "\0" . 'Entities\\Fifo' . "\0" . 'termekvaltozat', '' . "\0" . 'Entities\\Fifo' . "\0" . 'kibizonylatfej', '' . "\0" . 'Entities\\Fifo' . "\0" . 'kibizonylattetel', '' . "\0" . 'Entities\\Fifo' . "\0" . 'bebizonylatfej', '' . "\0" . 'Entities\\Fifo' . "\0" . 'bebizonylattetel', '' . "\0" . 'Entities\\Fifo' . "\0" . 'mennyiseg'];
        }
    ...
    public function getKibizonylatfej()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKibizonylatfej', []);
    ...
    public function getKibizonylattetel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKibizonylattetel', []);
