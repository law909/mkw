 ...
 */
class Feketelista extends \Entities\Feketelista implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Feketelista' . "\0" . 'id', '' . "\0" . 'Entities\\Feketelista' . "\0" . 'created', '' . "\0" . 'Entities\\Feketelista' . "\0" . 'email', '' . "\0" . 'Entities\\Feketelista' . "\0" . 'ok'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Feketelista $proxy) {
