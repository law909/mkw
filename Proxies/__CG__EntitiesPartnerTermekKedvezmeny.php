 ...
 */
class PartnerTermekKedvezmeny extends \Entities\PartnerTermekKedvezmeny implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\PartnerTermekKedvezmeny' . "\0" . 'id', '' . "\0" . 'Entities\\PartnerTermekKedvezmeny' . "\0" . 'created', '' . "\0" . 'Entities\\PartnerTermekKedvezmeny' . "\0" . 'lastmod', '' . "\0" . 'Entities\\PartnerTermekKedvezmeny' . "\0" . 'partner', '' . "\0" . 'Entities\\PartnerTermekKedvezmeny' . "\0" . 'termek', '' . "\0" . 'Entities\\PartnerTermekKedvezmeny' . "\0" . 'kedvezmeny'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartnerTermekKedvezmeny $proxy) {
    ...
    public function getTermekCikkszam()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTermekCikkszam', []);

        return parent::getTermekCikkszam();
    }
