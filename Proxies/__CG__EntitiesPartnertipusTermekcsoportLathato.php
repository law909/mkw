 ...
 */
class PartnertipusTermekcsoportLathato extends \Entities\PartnertipusTermekcsoportLathato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\PartnertipusTermekcsoportLathato' . "\0" . 'id', '' . "\0" . 'Entities\\PartnertipusTermekcsoportLathato' . "\0" . 'created', '' . "\0" . 'Entities\\PartnertipusTermekcsoportLathato' . "\0" . 'lastmod', '' . "\0" . 'Entities\\PartnertipusTermekcsoportLathato' . "\0" . 'partnertipus', '' . "\0" . 'Entities\\PartnertipusTermekcsoportLathato' . "\0" . 'termekcsoport'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartnertipusTermekcsoportLathato $proxy) {
