...
class Bizonylatstatusz extends \Entities\Bizonylatstatusz implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'id', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'nev', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'sorrend', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'csoport', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'foglal', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'mozgat', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'emailtemplate', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'bizonylatfejek', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'fizmod', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'szallitasimod', '' . "\0" . 'Entities\\Bizonylatstatusz' . "\0" . 'nemertekelheto'];
        }
