 ...
 */
class EntitiesTermekKapcsolodoProxy extends \Entities\TermekKapcsolodo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'created', 'lastmod', 'termek', 'altermek');
    }
