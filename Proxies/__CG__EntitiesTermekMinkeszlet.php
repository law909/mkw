 ...
 */
class TermekMinkeszlet extends \Entities\TermekMinkeszlet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\TermekMinkeszlet' . "\0" . 'id', '' . "\0" . 'Entities\\TermekMinkeszlet' . "\0" . 'created', '' . "\0" . 'Entities\\TermekMinkeszlet' . "\0" . 'lastmod', '' . "\0" . 'Entities\\TermekMinkeszlet' . "\0" . 'termek', '' . "\0" . 'Entities\\TermekMinkeszlet' . "\0" . 'raktar', '' . "\0" . 'Entities\\TermekMinkeszlet' . "\0" . 'minkeszlet'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekMinkeszlet $proxy) {
