...
class Bankszamla extends \Entities\Bankszamla implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'id', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'banknev', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'bankcim', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'szamlaszam', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'swift', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'iban', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'bank', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'valutanem', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'bizonylatfejek', '' . "\0" . 'Entities\\Bankszamla' . "\0" . 'migrid'];
        }
