 ...
 */
class TermekMenuTranslation extends \Entities\TermekMenuTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TermekMenuTranslation $proxy) {
