 ...
 */
class MNRLandingTranslation extends \Entities\MNRLandingTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MNRLandingTranslation $proxy) {
