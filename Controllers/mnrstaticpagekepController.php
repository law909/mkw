...
class mnrstaticpagekepController extends \mkwhelpers\MattableController
{
...
//		$this->setListBodyRowVarName('_egyed');
    ...
    public function loadVars($t)
    {
        $x = [];
        if (!$t) {
            $t = new \Entities\MNRStaticPageKep();
            $this->getEm()->detach($t);
            $x['oper'] = 'add';
    ...
    {
        $view = $this->createView('mnrstaticpagekepkarb.tpl');
        $x = $this->loadVars(null);
