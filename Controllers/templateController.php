...
//		$this->setEntityName('Entities\?Howto?');
        ...
        $this->fajlok = [
            ['id' => 'fejlecreklam', 'caption' => 'Fejléc reklámcsík', 'file' => 'tpl/main/' . $theme . '/headerfirstrow.tpl'],
            ['id' => 'lablec', 'caption' => 'Lábléc sablon', 'file' => 'tpl/main/' . $theme . '/footer.tpl'],
            ['id' => 'nincstalalat', 'caption' => 'Nincs keresési találat', 'file' => 'tpl/main/' . $theme . '/nincstalalat.tpl']
        ];
        parent::__construct();
    }
