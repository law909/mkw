...
class tartozaslistaController extends \mkwhelpers\MattableController
{
    ...
    public function getData(
        ...
        $q = $this->getEm()->createNativeQuery(
            ...
            . ' HAVING (tartozas < 0))'
            . ' UNION'
            . ' (SELECT COALESCE(MAX(f.bankbizonylatfej_id), MAX(f.penztarbizonylatfej_id)) AS bizonylat, f.partner_id, MAX(fm.nev) AS fizmodnev, \'\' AS felhasznalonev, p.nev, p.telefon, p.mobil, p.email, p.irszam,'
