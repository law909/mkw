<tr id="mattable-row_{$_partner.id}"{if ($_partner.vendeg)} class="guestpartner"{/if}>
    ...
    <td class="cell">
        ...
        <a class="mattable-dellink" href="#" data-partnerid="{$_partner.id}" data-oper="del" title="{t('Töröl')}"><span
        ...
        <table>
            ...
            <tr>
                <td>{t('Fizetési mód')}:</td>
                <td>{$_partner.fizmodnev}</td>
            </tr>
            <tr>
                <td>IP: {$_partner.ip}</td>
                <td>Ref.: {$_partner.referrer}</td>
            </tr>
            </tbody>
        </table>
    </td>
    ...
    <td class="cell">
        <table>
            ...
            {if ($_partner.fax!=='')}
                <tr>
                <td>{t('Fax')}: {$_partner.fax}</td></tr>{/if}
            {if ($_partner.email!=='')}
                <tr>
                <td><a href="mailto:{$_partner.email}" title="{t('Levélküldés')}">{$_partner.email}</a></td></tr>{/if}
            {if ($_partner.honlap!=='')}
                <tr>
                <td><a href="{$_partner.honlap}" title="{t('Ugrás a honlapra')}" target="_blank">{$_partner.honlap}</a></td></tr>{/if}
            </tbody>
        </table>
    </td>
    <td class="cell">
