...
{block "body"}
    ...
    {for $oldal = 1 to $maxoldalszam}
        <div class="fullwidth">
            <div class="biznev pull-left">{if $teszt}<span style="color:red">TESZT MÓD</span> {/if}{$egyed.bizonylatnev}{if ($egyed.allapotnev)} ({$egyed.allapotnev}){/if}</div>
        ...
        <table class="fullwidth">
            ...
            <tr>
                ...
                <td class="textaligncenter">{$egyed.fizmodnev_locale|default:"&nbsp;"}</td>
