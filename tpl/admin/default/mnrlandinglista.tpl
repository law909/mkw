...
{block "inhead"}
    ...
    <script type="text/javascript" src="/js/admin/default/mnrlanding.js"></script>
{/block}

{block "kozep"}
    <div id="mattable-select" data-theme="{$theme}">
        <div id="mattable-header" data-title="{at('Frissítés')}" data-caption="{at('MNR Landing page')}"></div>
