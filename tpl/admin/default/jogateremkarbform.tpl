        ...
        <div id="AltalanosTab" class="mattkarb-page" data-visible="visible">
            <table>
                ...
                <tr>
                    ...
                    <td><input id="MaxferohelyEdit" name="maxferohely" type="number" step="1" value="{$egyed.maxferohely}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label for="OrarendclassEdit">{at('Órarend CSS class')}:</label></td>
                    <td><input id="OrarendclassEdit" name="orarendclass" type="text" size="80" maxlength="255" value="{$egyed.orarendclass}"></td>
                </tr>
                </tbody>
            </table>
        </div>
