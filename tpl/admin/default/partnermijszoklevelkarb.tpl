<table id="mijszokleveltable_{$mijszoklevel.id}" class="ui-widget ui-widget-content ui-corner-all mattable-repeatable">
    ...
    <tr>
        <td><label for="MIJSZOklevelOklevelkibocsajtoEdit{$mijszoklevel.id}">{t('Oklevél kibocsájtó')}:</label></td>
        ...
        <td><label for="MIJSZOklevelOklevelszintEdit{$mijszoklevel.id}">{t('Oklevél szint')}:</label></td>
        ...
        <td><label for="OklevelevEdit{$mijszoklevel.id}">{t('Oklevél éve')}:</label></td>
        ...
        <td>
            <a class="js-mijszokleveldelbutton" href="#" data-id="{$mijszoklevel.id}"{if ($mijszoklevel.oper=='add')} data-source="client"{/if} title="{t('Töröl')}"><span class="ui-icon ui-icon-circle-minus"></span></a>
        </td>
    </tr>
    </tbody>
</table>
{if ($mijszoklevel.oper=='add')}
    <a class="js-mijszoklevelnewbutton" href="#" title="{t('Új')}"><span class="ui-icon ui-icon-circle-plus"></span></a>
{/if}