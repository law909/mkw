...
<td colspan="5"><select id="TermekSelect{$tetel.id}" name="teteltermek_{$tetel.id}" class="termekselect mattable-important" required="required">
...
<td><select id="VtszSelect{$tetel.id}" name="tetelvtsz_{$tetel.id}" class="vtszselect" required="required">
<option value="">{t('válasszon')}</option>
...
<td><select id="AfaSelect{$tetel.id}" name="tetelafa_{$tetel.id}" class="afaselect" required="required">
<option value="">{t('válasszon')}</option>
...
<td colspan="5"><input id="MennyisegEdit{$tetel.id}" class="mennyiseginput mattable-important" name="tetelmennyiseg_{$tetel.id}" type="number" step="any" value="{$tetel.mennyiseg}" maxlength="20" size="10" required="required">
...
<td><input id="NettoegysarEdit{$tetel.id}" name="tetelnettoegysar_{$tetel.id}" type="number" step="any" value="{$tetel.nettoegysar}" class="nettoegysarinput" required="required"></td>
<td><input name="tetelbruttoegysar_{$tetel.id}" type="number" step="any" value="{$tetel.bruttoegysar}" class="bruttoegysarinput" required="required"></td>
{if ($showvalutanem)}
...
<a class="teteldelbutton" href="#" data-id="{$tetel.id}"{if ($tetel.oper=='add')} data-source="client"{/if} title="{t('Töröl')}"><span class="ui-icon ui-icon-circle-minus"></span></a>
</div>
{if ($tetel.oper=='add')}
