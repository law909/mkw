...
<tr class="imageupload">
	<td><a class="js-toFlyout" href="{$adminurl}{$egyed.kepurl}" target="_blank"><img class="js-korhintakep" src="{$adminurl}{$egyed.kepurlsmall}" alt="{$egyed.kepleiras}" title="{$egyed.kepleiras}"/></a></td>
	<td>
		<table><tbody>
			<tr>
