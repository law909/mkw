<div id="mattkarb-header">
    ...
    {/if}
    <h3>{at('MNR Landing page')}</h3>
    <h4><a href="{$mainurl}/mnrlanding/{$egyed.id}" target="_blank">{$egyed.nev}</a></h4>
</div>
<form id="mattkarb-form" method="post" action="/admin/mnrlanding/save" data-id="{$egyed.id}">
    <div id="mattkarb-tabs">
        ...
        <div id="AltalanosTab" class="mattkarb-page" data-visible="visible">
            ...
            {include 'mnrlandingimagekarb.tpl'}
        </div>
        {if ($setup.multilang)}
