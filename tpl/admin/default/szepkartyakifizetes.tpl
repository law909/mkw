                ...
                {foreach $tomb as $_egyed}
                    <table data-egyedid="{$_egyed.id}" class="ui-widget ui-widget-content ui-corner-all mattable-repeatable">
                        ...
                        <tr>
                            <td class="cell">
                                {$_egyed.id}
                                <a class="js-kiegyenlit" href="#" data-egyedid="{$_egyed.id}" title="{at('Kiegyenlít')}"><span
                                        class="ui-icon ui-icon-check"></span></a>
                                <table>
                                    <tbody>
                                    <tr>
                            ...
                            <td class="cell">
                                <table>
                                    <tbody>
                                    <tr>
                                        <td class="mattable-important">{$_egyed.szepkartyatipus}</td>
                                    </tr>
                                    <tr>
                                        <td class="mattable-important">{$_egyed.szepkartyaszam}</td>
                                    </tr>
                                    <tr>
                                        <td class="mattable-important">{$_egyed.szepkartyanev}</td>
                                    </tr>
                                    <tr>
                                        <td class="mattable-important">{$_egyed.szepkartyaervenyesseg}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
