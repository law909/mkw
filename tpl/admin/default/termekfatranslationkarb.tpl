<table id="translationtable_{$translation.id}" class="ui-widget ui-widget-content ui-corner-all mattable-repeatable">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="js-translationdelbutton" href="#" data-id="{$translation.id}" data-faid="{$fa.id}"{if ($translation.oper=='add')} data-source="client"{/if} title="{t('Töröl')}"><span class="ui-icon ui-icon-circle-minus"></span></a>
            </td>
        </tr>
    </tbody>
</table>
