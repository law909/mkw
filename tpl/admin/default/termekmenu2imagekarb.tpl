<table id="ImageEdit">
    <tbody>
    <tr>
        <td>{if ($egyed.kepurl)}<a class="js-toflyout" href="{$mainurl}{$egyed.kepurl}" target="_blank"><img class="js-termekmenu2kep"
                                                                                                             src="{$mainurl}{$egyed.kepurlsmall}"
                                                                                                             alt="{$egyed.kepleiras}"
                                                                                                             title="{$egyed.kepleiras}"/></a>{/if}</td>
        <td>
            <table>
                <tbody>
                <tr>
