<tr id="mattable-row_{$_egyed.id}" data-egyedid="{$_egyed.id}">
    ...
    <td class="cell">
        ...
        <table>
            ...
            <tr>
                <td>Webcím:</td>
                <td><a href="{$_egyed.url}" target="_blank">{$_egyed.url}</a></td>
            </tr>
            <tr>
                <td>Dátum:</td>
                <td>{$_egyed.kezdodatum} {$_egyed.kezdoido}</td>
            </tr>
            <tr>
                <td>Termék a számlán</td>
                <td>{$_egyed.termeknev}</td>
            </tr>
            <tr>
                <td>Ár:</td>
            ...
            <tr>
                ...
                <td>{$_egyed.earlybirdvege}</td>
            </tr>
            <tr>
                <td>Helyszín:</td>
                <td>{$_egyed.helyszinnev}</td>
            </tr>
            <tr>
                <td>Terem:</td>
                <td>{$_egyed.jogateremnev}</td>
            </tr>
            <tr>
                <td>Számlázási adat bekérés:</td>
                <td>{if ($_egyed.kellszamlazasiadat)}van{else}nincs{/if}</td>
            </tr>
            <tr>
                <td>Órarendben szerepel:</td>
                <td>{if ($_egyed.orarendbenszerepel)}igen{else}nem{/if}</td>
            </tr>
            <tr>
                <td>Regisztrációs form:</td>
                <td><a href="#" class="js-uidcopy" data-clipboard-text="{$_egyed.reglink}">Másolás vágólapra</a></td>
            </tr>
            <tr>
                <td>Max. férőhely:</td>
                <td>{$_egyed.maxferohely}</td>
            </tr>
            <tr>
                <td>{if ($_egyed.varolistavan)}Van{else}Nincs{/if} várólista</td>
                <td></td>
            </tr>
            </tbody>
        </table>
