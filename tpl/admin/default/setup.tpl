            ...
            <div id="mattkarb-tabs">
                ...
                <div id="DefaTab" class="mattkarb-page" data-visible="visible">
                    <div class="ui-widget ui-widget-content ui-corner-all mattable-repeatable">
                        ...
                        <div class="setuprow">
                            <span class="setuplabel"><label for="KeszpenzFizmodEdit">{at('Készpénz fizetési mód')}:</label></span>
                            <select id="KeszpenzFizmodEdit" name="keszpenzfizmod">
                                <option value="">{at('válasszon')}</option>
                                {foreach $keszpenzfizmodlist as $_fizmod}
                                    <option value="{$_fizmod.id}"{if ($_fizmod.selected)} selected="selected"{/if}>{$_fizmod.caption}</option>
                                {/foreach}
                            </select>
                        </div>
                        ...
                        <div class="setuprow">
                            <span class="setuplabel"><label for="ElallasElismervenySablonEdit">{at('Elállás átvételi elismervény sablon')}:</label></span>
                            <select id="ElallasElismervenySablonEdit" name="elallaselismervenysablon">
                                <option value="">{at('válasszon')}</option>
                                {foreach $elallaselismervenysablonlist as $_belsouk}
                                    <option value="{$_belsouk.id}"{if ($_belsouk.selected)} selected="selected"{/if}>{$_belsouk.caption}</option>
                                {/foreach}
                            </select>
                        </div>
                    ...
                    {if ($maintheme === 'darshan' || $setup.darshan == 1)}
                        ...
                        <div class="ui-widget ui-widget-content ui-corner-all mattable-repeatable">
                            ...
                            <div class="setuprow">
                                <span class="setuplabel"><label for="jogaberletszamlazvasablonEdit">{at('Jóga bérlet számlázva')}:</label></span>
                                <select id="jogaberletszamlazvasablonEdit" name="jogaberletszamlazvasablon">
                                    <option value="">{at('válasszon')}</option>
                                    {foreach $jogaberletszamlazvasablonlist as $_belsouk}
                                        <option value="{$_belsouk.id}"{if ($_belsouk.selected)} selected="selected"{/if}>{$_belsouk.caption}</option>
                                    {/foreach}
                                </select>
                            </div>
                        ...
                        <div class="ui-widget ui-widget-content ui-corner-all mattable-repeatable">
                            ...
                            <div class="setuprow">
                                <span class="setuplabel"><label
                                        for="IdopontfoglalasEmlekeztetoSablonEdit">{at('Időpont foglalás emlékeztető levél sablon')}:</label></span>
                                <select id="IdopontfoglalasEmlekeztetoSablonEdit" name="idopontfoglalasemlekeztetoemailsablon">
                                    <option value="">{at('válasszon')}</option>
                                    {foreach $idopontfoglalasemlekeztetoemailsablonlist as $_belsouk}
                                        <option value="{$_belsouk.id}"{if ($_belsouk.selected)} selected="selected"{/if}>{$_belsouk.caption}</option>
                                    {/foreach}
                                </select>
                            </div>
                            <div class="setuprow">
                                <span class="setuplabel"><label
                                        for="IdopontfoglalasLemondasSablonEdit">{at('Időpont foglalás lemondás levél sablon')}:</label></span>
                                <select id="IdopontfoglalasLemondasSablonEdit" name="idopontfoglalaslemondasemailsablon">
                                    <option value="">{at('válasszon')}</option>
                                    {foreach $idopontfoglalaslemondasemailsablonlist as $_belsouk}
                                        <option value="{$_belsouk.id}"{if ($_belsouk.selected)} selected="selected"{/if}>{$_belsouk.caption}</option>
                                    {/foreach}
                                </select>
                            </div>
                            <div class="setuprow">
                                <span class="setuplabel"><label
                                        for="AdategyeztetoSablonEdit">{at('Adategyeztető link levél sablon')}:</label></span>
                                <select id="AdategyeztetoSablonEdit" name="adategyeztetosablon">
                                    <option value="">{at('válasszon')}</option>
                                    {foreach $adategyeztetosablonlist as $_belsouk}
                                        <option value="{$_belsouk.id}"{if ($_belsouk.selected)} selected="selected"{/if}>{$_belsouk.caption}</option>
                                    {/foreach}
                                </select>
                            </div>
