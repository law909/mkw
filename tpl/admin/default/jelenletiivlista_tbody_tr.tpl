...
<td class="cell">
<a class="mattable-editlink" href="#" data-egyedid="{$_egyed.id}" data-oper="edit" title="{t('Szerkeszt')}">{$_egyed.dolgozonev}</a>
...
<td class="cell">{$_egyed.jelenlettipusnev}: {$_egyed.munkaido} {t('óra')}</td>
