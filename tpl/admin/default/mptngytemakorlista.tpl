...
{block "inhead"}
    ...
    <script type="text/javascript" src="/js/admin/default/mptngytemakor.js"></script>
{/block}

{block "kozep"}
    <div id="mattable-select" data-theme="{$theme}">
        <div id="mattable-header" data-title="{at('Frissítés')}" data-caption="{at('MPT NGY témakörök')}"></div>
