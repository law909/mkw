...
<td class="cell"><input class="CimkeCheckbox" type="checkbox"></td>
<td class="cell">
<table><tbody>
...
<td class="cell">
<a href="#" class="menulathatocheckbox{if ($_cimke.menu1lathato)} ui-state-hover{/if}" data-num=1>{t('Menü 1')}</a>
<a href="#" class="menulathatocheckbox{if ($_cimke.menu2lathato)} ui-state-hover{/if}" data-num=2>{t('Menü 2')}</a>
<a href="#" class="menulathatocheckbox{if ($_cimke.menu3lathato)} ui-state-hover{/if}" data-num=3>{t('Menü 3')}</a>
<a href="#" class="menulathatocheckbox{if ($_cimke.menu4lathato)} ui-state-hover{/if}" data-num=4>{t('Menü 4')}</a>
</td>
