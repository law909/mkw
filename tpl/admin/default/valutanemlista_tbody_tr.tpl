<tr id="mattable-row_{$_egyed.id}" data-egyedid="{$_egyed.id}">
    ...
    <td class="cell">{if ($_egyed.kerekit)}{at('igen')}{else}{at('nem')}{/if}</td>
    <td class="cell">{if ($_egyed.hivatalos)}{at('igen')}{else}{at('nem')}{/if}</td>
    <td class="cell">{$_egyed.mincimlet}</td>
    <td class="cell">{$_egyed.bankszamlanev}</td>
</tr>
