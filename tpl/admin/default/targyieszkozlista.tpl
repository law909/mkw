...
<div id="mattable-header" data-title="{t('Frissítés')}" data-caption="{t('Tárgyieszközök')}"></div>
...
<thead>
	...
	<th>{t('Leltári szám')}</th>
	<th>{t('Név')}</th>
	<th>{t('Csoport')}</th>
	<th>{t('Beszerzés dátuma')}</th>
	<th>{t('Elszámolás kezdete számviteli tv. szerint')}</th>
