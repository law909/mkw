            ...
            <div id="DefaTab" class="mattkarb-page" data-visible="visible">
                <form id="pdfszamlaexport" action="" target="_blank">
                    ...
                    <fieldset class="mattkarb-doboz">
                        ...
                        <div>
                            <a href="/admin/pdfszamlaexport/download" class="js-downloadbutton" data-szures="kelt">{at('Letölt')}</a>
                            <a href="/admin/pdfszamlaexport/sendemail" class="js-emailbutton" data-szures="kelt">{at('Küld')}</a>
                        </div>
                    </fieldset>
