    ...
    <td class="cell">
        <table>
            <tbody>
                ...
                <tr><td><a href="#" data-id="{$_termek.id}" data-flag="termekexportbanszerepel" class="js-flagcheckbox{if ($_termek.termekexportbanszerepel)} ui-state-hover{/if}">{t('Exportokban szerepel')}</a></td></tr>
