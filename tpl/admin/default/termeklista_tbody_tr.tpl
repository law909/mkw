...
<div><div>
<table><tbody>
<tr><td><a class="toFlyout" href="{$_termek.kepurl}" target="_blank"><img src="{$_termek.kepurlsmall}"/></a></td>
...
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="inaktiv" class="flagcheckbox{if ($_termek.inaktiv)} ui-state-hover{/if}">{t('Inaktív')}</a></td></tr>
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="lathato" class="flagcheckbox{if ($_termek.lathato)} ui-state-hover{/if}">{t('Látható')}</a></td></tr>
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="ajanlott" class="flagcheckbox{if ($_termek.ajanlott)} ui-state-hover{/if}">{t('Ajánlott')}</a></td></tr>
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="kiemelt" class="flagcheckbox{if ($_termek.kiemelt)} ui-state-hover{/if}">{t('Kiemelt')}</a></td></tr>
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="hozzaszolas" class="flagcheckbox{if ($_termek.hozzaszolas)} ui-state-hover{/if}">{t('Hozzá lehet szólni')}</a></td></tr>
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="mozgat" class="flagcheckbox{if ($_termek.mozgat)} ui-state-hover{/if}">{t('Készletet mozgat')}</a></td></tr>
<tr><td><a href="#" data-id="{$_termek.id}" data-flag="nemkaphato" class="flagcheckbox{if ($_termek.nemkaphato)} ui-state-hover{/if}">{t('Nem kapható')}</a></td></tr>
