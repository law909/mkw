<div class="control-group">
    ...
    <label class="control-label" for="MIJSZOklevelOklevelkibocsajtoEdit{$mijszoklevel.id}">{t('Oklevél')}:</label>
    ...
    <a class="js-mijszokleveldelbutton btn btn-warning" href="#" data-id="{$mijszoklevel.id}"{if ($mijszoklevel.oper=='add')} data-source="client"{/if} title="{t('Töröl')}">{t('Töröl')}</a>
</div>
