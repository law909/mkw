<div class="control-group">
    ...
    <input class="input-mini" id="puneevEdit{$mijszpune.id}" type="number" name="mijszpuneev_{$mijszpune.id}" value="{$mijszpune.ev}">
    <input class="input-mini" id="punehonapEdit{$mijszpune.id}" type="number" name="mijszpunehonap_{$mijszpune.id}" value="{$mijszpune.honap}">
