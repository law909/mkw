                                ...
                                <div class="row">
                                    ...
                                    <div class="span5 termektext">
                                        ...
                                        {if ($_termek.szallitasiido && (!$_termek.nemkaphato))}
                                            <div><span class="bold">{t('Szállítási idő')}: </span>max. <span id="termekszallitasiido{$_termek.id}-{$_termek.valtozatid|default}">{$_termek.szallitasiido}</span> {t('munkanap')}</div>
                                        {/if}
