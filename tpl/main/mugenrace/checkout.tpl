                ...
                <form id="CheckoutForm" class="" action="/checkout/ment" method="post">
                    <fieldset>
                        ...
                        {if (!$user.loggedin)}
                            <div class="row">
                                <div class="span10">
                                    <div class="chk-datagroupheader js-chkdatagroupheader" data-container=".js-chklogin">{$sorszam++}
                                        . {t('Bejelentkezés')}</div>
                        ...
                        <div class="row">
                            <div class="span10">
                                <div id="block2" class="chk-datagroupheader js-chkdatagroupheader js-chkszallitasiadatokgh"
                                     data-container=".js-chkszallitasiadatok">{$sorszam++}. {t('Szállítási és számlázási adatok')}<a>{t('Módosít')}</a></div>
                                <div class="js-chkszallitasiadatok js-chkdatacontainer">
                                    ...
                                    <div class="controls controls-row chk-controloffset">
                                        <div class="span4 nomargin chk-relative">
                                            ...
                                            <input name="telefon" type="text" class="span4 nomargin js-chkrefresh" value="{$telefon|default}"
                                                   data-container=".js-chkszallitasiadatok">
                                        </div>
                                        <div class="span4">
                                    ...
                                    <div class="controls chk-controloffset">
                                        <div class="span8 nomargin">
                                            <label class="span8 nomargin">{t('Szállítási ország')} *</label>
                                    ...
                                    <div class="controls chk-controloffset">
                                        <div class="span8 nomargin">
                                            <label class="span8 nomargin">{t('Számlázási ország')} *</label>
                        ...
                        <div class="row">
                            <div class="span10">
                                <div id="block3" class="chk-datagroupheader js-chkdatagroupheader js-chkszallmoddgh"
                                     data-container=".js-chkszallmod">{$sorszam++}. {t('Szállítás és fizetés')}<a>{t('Módosít')}</a></div>
                                <div class="js-chkszallmod js-chkdatacontainer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="span7 controls"><textarea id="WebshopMessageEdit" class="span5 js-chkrefresh" name="webshopmessage"
                                                                              rows="2">{$webshopmessage}</textarea></div>
                                    </div>
                                    <div class="row">
                                        <div class="span2"><label for="CourierMessageEdit" class="bold">{t('Üzenet a futár részére')}:</label></div>
                                        <div class="span7 controls"><textarea id="CourierMessageEdit" class="span5 js-chkrefresh" name="couriermessage"
                                                                              rows="2">{$couriermessage}</textarea></div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="span10">
                                <div id="block4" class="chk-datagroupheader js-chkdatagroupheader js-chkattekintesdgh"
                                     data-container=".js-chkattekintes">{$sorszam++}. {t('Megrendelés áttekintése')}</div>
                                <div class="js-chkattekintes js-chkdatacontainer">
                                    ...
                                    <div class="pull-right">
                                        <div class="chk-savecontainer">
                                            ...
                                            <div><input type="submit" class="btn cartbtn chk-sendorderbtn js-chksendorderbtn"
