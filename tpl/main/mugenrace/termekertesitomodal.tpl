    ...
    <div class="modal-body">
        <p>
            {if ($locale === 'hu' || $locale === 'hu_hu')}
                Ez a termék sajnos most nincs készleten.
                <br>
                Adja meg emailcímét, és
                <strong>azonnal értesítjük</strong>
                , amint ismét elérhető lesz!
            {elseif ($locale === 'en' || $locale === 'en_us')}
                Sorry, we don't have this product in stock.
                <br>
                Subscribe to our advice note!
            {/if}
        </p>
        <form id="termekertesitoform" class="form-horizontal" action="/termekertesito/save" method="post">
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="EmailEdit" name="email" type="email" class="input-large" value="{$user.email|default}" required
