...
<section id="{$blokk.id}" 
  class="
    ...
    {if (isset($blokk.szovegigazitas) && $blokk.szovegigazitas==1)} left {/if}
    {if (isset($blokk.szovegigazitas) && $blokk.szovegigazitas==2)} centeer {/if}
    {if (isset($blokk.szovegigazitas) && $blokk.szovegigazitas==3)} right {/if}
