<div class="footer container-full__with-padding">
	<div class="row">
		<div class="col flex-col footer__left">
			...
			<a href="https://www.barion.com/en/about-secure-online-payment" target="_blank" class="pull-right barionbanner">
				<img class="footer__barion" src="/themes/main/mugenrace2026/img/barion-card-payment-banner-2016-432x50px.png" title="Secure and comfortable online payment is provided by Barion Payment Inc, license number: H-EN-I-1064/2013 Your card details are not disclosed to our shop.">
			</a>
			<p>
