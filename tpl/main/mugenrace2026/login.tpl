                    ...
                    <form id="Regform" action="/regisztracio/ment" method="post">
                        <fieldset>
                            <div class="controls controls-row chk-controloffset">
                                <input id="VezeteknevEdit" name="vezeteknev" type="text" class="span" value="{$vezeteknev|default}"
                                       placeholder="{t('vezetéknév')} *" required data-errormsg="{t('Adja meg a nevét')}">
                                <input id="KeresztnevEdit" name="keresztnev" type="text" class="span" value="{$keresztnev|default}"
                                       placeholder="{t('keresztnév')} *" required>
                            </div>
                            <div class="controls controls-row chk-controloffset">
                                <input id="EmailEdit" name="email" type="email" class="span" value="{$email|default}" placeholder="{t('email')} *" required
                                       data-errormsg1="{t('Adja meg az emailcímét')}" data-errormsg2="{t('Kérjük emailcímet adjon meg.')}">
                            </div>
                            <div class="controls controls-row chk-controloffset">
