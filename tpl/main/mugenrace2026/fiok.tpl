...
{block "kozep"}
    <div class="container page-header static-page__header">
        ...
        <div class="row">
            <div class="col">
                <h1 class="page-header__title">{t('Fiókom')}</h1>
            </div>
        </div>
    </div>
                            ...
                            <form id="FiokSzamlaAdatok" class="form-horizontal" action="/fiok/ment/szamlaadatok" method="post">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="SzamlazasiNevEdit" name="nev" type="text" class="input-xlarge" placeholder="{t('számlázási név')}"
                                                   value="{$user.nev}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                                    ...
                                                    {foreach $megr.tetellista as $tetel}
                                                        <tr class="clickable" data-href="{$tetel.link}">
                                                            ...
                                                            <td>
                                                                ...
                                                                {$tetel.cikkszam}</td>
                                                            <td>
                                                                <div class="textalignright">{number_format($tetel.bruttoegysar,0,',',' ')}</div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="textalignright">{number_format($tetel.brutto,0,',',' ')}</div>
                                                            </td>
                                                        </tr>
                                                    {/foreach}
                                                    </tbody>
                        ...
                        <div class="tab-pane" id="termekertesito">
                            {foreach $ertesitok as $ertesito}
                                <div class="row js-termekertesito">
                                    <div class="span1"><a href="/product/{$ertesito.termek.slug}"><img src="{$imagepath}{$ertesito.termek.kiskepurl}"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="chk-relative pull-left">
                                                <input id="Jelszo1Edit" name="jelszo1" type="password" class="span" required placeholder="{t('jelszó')} 1 *"
