...
<html lang="hu">
	<head>
        ...
        <script src="/js/main/mugenrace2026/mgrerrorlog.js"></script>
        ...
        <script src="/js/main/mugenrace2026/jquery.magnify.js"></script>
        <script src="/js/main/mugenrace2026/jquery.magnify-mobile.js"></script>
