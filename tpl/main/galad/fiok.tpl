...
{block "script"}
    <script src="/js/main/galad/fiok.js"></script>
{/block}
    ...
    <div class="row">
        <ul class="fioknav nav nav-pills nav-stacked col-md-3">
            {if ($uzletkoto.loggedin && $uzletkoto.fo)}
                <li><a href="#mindenmegrend" data-toggle="pill">Minden rendelés</a></li>
            {/if}
            <li class="active"><a href="#adataim" data-toggle="pill">Kapcsolattartás</a></li>
            <li><a href="#szamlaadatok" data-toggle="pill">Számlázási cím</a></li>
            <li><a href="#szallitasiadatok" data-toggle="pill">Szállítási cím</a></li>
            {if ($uzletkoto.loggedin)}
                <li><a href="#discounts" data-toggle="pill">Kedvezményeim</a></li>
            {/if}
            <li><a href="#megrend" data-toggle="pill">Rendeléseim</a></li>
            <li><a href="#szamla" data-toggle="pill">Számláim</a></li>
            <li><a href="#garanciaugy" data-toggle="pill">Garanciális ügyeim</a></li>
            <li><a href="#jelszo" data-toggle="pill">Jelszócsere</a></li>
        </ul>
        <div class="fioknav tab-content col-md-9">
                ...
                <div class="tab-pane" id="mindenmegrend">
                    {if (count($mindenmegrendeleslist)>0)}
                        <table class="acc-megrendeles">
                            ...
                            <td>Dátum</td>
                            <td>Állapot</td>
                            <td class="textalignright">Érték</td>
                            <td></td>
                            </thead>
                            ...
                            {foreach $mindenmegrendeleslist as $megr}
                                <tr class="acc-megrendelesbordertop acc-megrendelestablerow js-accmegrendelesopen">
                                    ...
                                    <td><a href="#" class=""><img src="/themes/main/galad/img/i_down.png"></a></td>
                                </tr>
                    ...
                    {else}
                        Még nincs rendelés sem Önnek, sem az üzletkötőinek.
                    {/if}
                </div>
            {/if}
            <div class="tab-pane active" id="adataim">
                <form id="FiokAdataim" class="form-horizontal" action="/fiok/ment/adataim" method="post">
                    <div>
                        <label class="control-label" for="VezeteknevEdit">{t('Keresztnév')}*:</label>
                        <div class="controls">
                            <input id="KeresztnevEdit" name="keresztnev" type="text" class="form-control" value="{$user.keresztnev}" required>
                        </div>
                    </div>
                    <div>
                        <label class="control-label" for="VezeteknevEdit">{t('Vezetéknév')}*:</label>
                        <div class="controls">
            ...
            <div class="tab-pane" id="szallitasiadatok">
                <div class="acc-copyszamlaadat">
                    <a class="js-copyszamlaadat">Számlázási cím másolása</a>
                </div>
            ...
            <div class="tab-pane" id="garanciaugy">
                ...
                <form id="GaranciaUgyForm" class="form-horizontal" action="/fiok/ment/" method="post" style="display: none;">
                    <div>
                        <label class="control-label" for="ItemEdit">{t('Termék')}:</label>
                        <div class="controls">
                    ...
                    <div>
                        <label class="control-label" for="PurchaseDateEdit">{t('Vásárlás dátuma')}:</label>
                        <div class="controls">
            ...
            <div class="tab-pane" id="jelszo">
                <form id="JelszoChangeForm" class="form-horizontal" action="/fiok/ment/jelszo" method="post">
                    <fieldset>
                        ...
                        <div>
                            <label class="control-label">Új jelszó még egyszer:</label>
                            <div class="controls">
