        ...
        <div class="col-md-8">
            <form class="valtozatform">
                <table class="valtozattable">
                    ...
                    <tr>
                        ...
                        <th class="textalignright">Egységár</th>
                        <!--th class="textalignright">Készlet</th-->
                        <th class="textaligncenter">Rendelés</th>
                    </tr>
                    </thead>
                    <tbody>
            ...
            <div>
                {if ($termek.ar > 0 && !$nemrendelhet)}
                    <a href="/kosar/multiadd" class="btn btn-large btn-primary desktopright js-kosarbabtn" data-termekid="{$termek.id}">Kosárba</a>
                {/if}
            </div>
        </div>
    </div>
