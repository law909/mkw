{extends "base.tpl"}
{block "script"}
<script src="/js/main/mkwnew/bootstrap-transition.js"></script>
<script src="/js/main/mkwnew/bootstrap-carousel.js"></script>
<script src="/js/main/mkwnew/jquery-ui.min.js"></script>
<script src="/js/main/mkwnew/jquery.ui.rcarousel.min.js"></script>
{/block}
{block "kozep"}
<div class="row">
	<div class="span12">
