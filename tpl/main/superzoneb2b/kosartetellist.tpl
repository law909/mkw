...
<tr>
    ...
    <th><div class="textalignright">Net.value</div></th>
    <th><div class="textalignright">Gr.value</div></th>
    <th></th>
</tr>
</thead>
<tbody>
...
{foreach $tetellista as $tetel}
    ...
    <tr data-href="{$tetel.link}">
        ...
        <td><div id="egysegar_{$tetel.id}" class="textalignright">{number_format($tetel.nettoegysar, 2, ',', ' ')} {$valutanem}</div></td>
        ...
        <td><div id="nettoertek_{$tetel.id}" class="textalignright">{number_format($tetel.netto, 2, ',', ' ')} {$valutanem}</div></td>
        <td><div id="bruttoertek_{$tetel.id}" class="textalignright">{number_format($tetel.brutto, 2, ',', ' ')} {$valutanem}</div></td>
...
<tr>
    ...
    <th><div id="kosarnettosum" class="textalignright">{number_format($nettoosszesen, 2, ',', ' ')} {$valutanem}</div></th>
    <th><div id="kosarbruttosum" class="textalignright">{number_format($osszesen, 2, ',', ' ')} {$valutanem}</div></th>
    <th></th>
</tr>
</tfoot>
