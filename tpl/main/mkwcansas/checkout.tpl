            ...
            <div class="span10">
                ...
                <form id="CheckoutForm" class="" action="/checkout/ment" method="post">
                    <fieldset>
                                        ...
                                        <div class="span5">
                                            <div class="chk-loginrightborder pull-left">
                                                ...
                                                <div class="span">
                                                    ...
                                                    <div class="chk-courierdesc folyoszoveg">Regisztrációval olyan előnyökhöz juthat, mint például a hűségpontok
                                                        gyűjtése és beváltása, rendelések nyomon követése, termékértékelések írása, és sokminden más.
                                                    </div>
                                                </div>
                                                <div class="row chk-actionrow span"><a href="#block2" class="btn okbtn pull-right js-chkopenbtn"
                                                                                       data-datagroupheader=".js-chkszallitasiadatokgh">Tovább</a></div>
                                            </div>
                                        </div>
                                        <div class="span5">
                        ...
                        <div class="row">
                            <div class="span10">
                                <div id="block2" class="chk-datagroupheader js-chkdatagroupheader js-chkszallitasiadatokgh"
                                     data-container=".js-chkszallitasiadatok">{$sorszam++}. Szállítási és számlázási adatok<a>Módosít</a></div>
                                <div class="js-chkszallitasiadatok js-chkdatacontainer">
                                    ...
                                    <div class="controls controls-row chk-controloffset">
                                        <div class="span4 nomargin">
                                            ...
                                            <input name="vezeteknev" type="text" class="span4 nomargin js-chkrefresh" value="{$vezeteknev|default}"
                                                   data-container=".js-chkszallitasiadatok">
                                        </div>
                                        <div class="span4">
                                            <label class="span4 nomargin">Keresztnév *</label>
                                            <input name="keresztnev" type="text" class="span4 nomargin js-chkrefresh" value="{$keresztnev|default}"
                                                   data-container=".js-chkszallitasiadatok">
                                        </div>
                                    </div>
                                    <div class="controls controls-row chk-controloffset">
                                        <div class="span4 nomargin chk-relative">
                                            ...
                                            {/if}
                                            <div class="controls">
                                                <select id="TelkorzetEdit" class="telszam js-chkrefresh" name="telkorzet"
                                                        data-errormsg="{t('Hibás telefonszám')}" data-container=".js-chkszallitasiadatok">
                                                    <option value="">{t('válasszon')}</option>
                                                    {foreach $telkorzetlist as $tk}
                                                        <option value="{$tk.id}"
                                                                data-hossz="{$tk.hossz}"{if ($tk.selected)} selected="selected"{/if}>{$tk.id}</option>
                                                    {/foreach}
                                                </select>
                                                <input id="TelszamEdit" class="telszam js-chkrefresh" type="text" name="telszam" value="{$telszam}"
                                                       data-container=".js-chkszallitasiadatok">
                                            </div>
                                            <i class="icon-question-sign chk-tooltipbtn hidden-phone js-chktooltipbtn"
                                               title="Csak mobil számot adjon meg, mert a futár arra tud SMS-t küldeni. A telefonszámra azért van szükségünk, mert ezen keresztül egyeztetünk Önnel a kiszállításról, illetve a futár is így fogja tudni Önnel felvenni a kapcsolatot."></i>
                                        </div>
                                        <div class="span4">
                                            <label class="span4 nomargin">Email *</label>
                                            <input name="kapcsemail" type="text" class="span4 nomargin js-chkrefresh" value="{$email|default}"
                                        ...
                                        <div class="js-checkoutpasswordcontainer">
                                            <div class="controls controls-row chk-controloffset js-checkoutpasswordrow">
                                                <div class="span4 nomargin">
                                                    ...
                                                    <input name="jelszo1" type="password" class="span4 nomargin" value=""
                                                           data-container=".js-chkszallitasiadatok">
                                                </div>
                                                <div class="span4 chk-relative">
                                                    <label class="span4 nomargin">Jelszó 2 *</label>
                                                    <input name="jelszo2" type="password" class="span4 nomargin" value=""
                                                           data-container=".js-chkszallitasiadatok">
                                                    <i class="icon-question-sign chk-tooltipbtn hidden-phone js-chktooltipbtn"
                                                       title="Adja meg kétszer jelszavát, így elkerülheti az elgépelést"></i>
                                                </div>
                                            </div>
                                        </div>
                                    {/if}
                                    ...
                                    <div class="controls chk-controloffset">
                                        <div class="span10 nomargin">
                                            ...
                                            <input name="szallnev" type="text" class="span8 js-chkrefresh" value="{$szallnev|default}"
                                                   data-container=".js-chkszallitasiadatok">
                                        </div>
                                    </div>
                                    <div class="controls controls-row chk-controloffset">
                                        <div class="span2 nomargin">
                                            ...
                                            <input name="szallirszam" type="text" class="span2 nomargin js-chkrefresh" value="{$szallirszam|default}"
                                                   data-container=".js-chkszallitasiadatok">
                                        </div>
                                        <div class="span6">
                                            <label class="span7 nomargin">Város *</label>
                                            <input name="szallvaros" type="text" class="span6 nomargin js-chkrefresh" value="{$szallvaros|default}"
                                                   data-container=".js-chkszallitasiadatok">
                                        </div>
                                    </div>
                                    <div class="controls chk-controloffset">
                                        <label class="span8 nomargin">Utca *</label>
                                        <input name="szallutca" type="text" class="span8 nomargin js-chkrefresh" value="{$szallutca|default}"
                                               data-container=".js-chkszallitasiadatok">
                                    </div>
                                    ...
                                    <div class="js-chkszamlaadatok{if ($szamlaeqszall|default)} notvisible{/if}">
                                        <div class="controls chk-controloffset">
                                            <div class="span10 nomargin">
                                                ...
                                                <input name="szamlanev" type="text" class="span8 nomargin js-chkrefresh" value="{$szamlanev|default}"
                                        ...
                                        <div class="controls controls-row chk-controloffset">
                                            <div class="span2 nomargin">
                                                <label class="span2 nomargin">Ir.szám *</label>
                                                <input name="szamlairszam" type="text" class="span2 nomargin js-chkrefresh" value="{$szamlairszam|default}"
                                                       {if ($szamlaeqszall|default)}disabled {/if}data-container=".js-chkszallitasiadatok">
                                            </div>
                                            <div class="span6">
                                                <label class="span7 nomargin">Város *</label>
                                                <input name="szamlavaros" type="text" class="span6 nomargin js-chkrefresh" value="{$szamlavaros|default}"
                                                       {if ($szamlaeqszall|default)}disabled {/if}data-container=".js-chkszallitasiadatok">
                                            </div>
                                        </div>
                                        <div class="controls chk-controloffset">
                                            <label class="span8 nomargin">Utca *</label>
                                            <input name="szamlautca" type="text" class="span8 nomargin js-chkrefresh" value="{$szamlautca|default}"
                                                   {if ($szamlaeqszall|default)}disabled {/if}data-container=".js-chkszallitasiadatok">
                                        </div>
                                        <div class="controls controls-row chk-controloffset">
                                            <div class="span3 nomargin chk-relative">
                                                <label class="span3 nomargin">Adószám</label>
                                                <input name="adoszam" type="text" class="span3 nomargin js-chkrefresh" data-inputmask="'mask': '99999999-9-99'"
                                                       value="{$adoszam|default}">
                                                <i class="icon-question-sign chk-tooltipbtn hidden-phone js-chktooltipbtn"
                                                   title="Nem kötelező kitölteni az adószámot. Akkor adja meg, ha cég nevére vásárol, és szeretné, ha a számlán szerepelne ez az adat is."></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row chk-actionrow"><a href="#block3" class="btn okbtn pull-right js-chkopenbtn"
                                                                      data-datagroupheader=".js-chkszallmoddgh">Tovább</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="span10">
                                <div id="block3" class="chk-datagroupheader js-chkdatagroupheader js-chkszallmoddgh"
                                     data-container=".js-chkszallmod">{$sorszam++}. Szállítás<a>Módosít</a></div>
                                <div class="js-chkszallmod js-chkdatacontainer">
                                    ...
                                    <div class="row chk-actionrow"><a href="#block4" class="btn okbtn pull-right js-chkopenbtn"
                                                                      data-datagroupheader=".js-chkfizmoddgh">Tovább</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="span10">
                                <div id="block4" class="chk-datagroupheader js-chkdatagroupheader js-chkfizmoddgh" data-container=".js-chkfizmod">{$sorszam++}.
                                    Fizetés<a>Módosít</a></div>
                                <div class="js-chkfizmod js-chkdatacontainer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="span7 controls"><textarea id="WebshopMessageEdit" class="span5 js-chkrefresh" name="webshopmessage" rows="2"
                                                                              placeholder="pl. megrendeléssel, számlázással kapcsolatos kérések">{$webshopmessage}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="span2"><label for="CourierMessageEdit" class="bold">Üzenet a futár részére:</label></div>
                                        <div class="span7 controls"><textarea id="CourierMessageEdit" class="span5 js-chkrefresh" name="couriermessage" rows="2"
                                                                              placeholder="pl. kézbesítéssel kapcsolatos kérések">{$couriermessage}</textarea>
                                        </div>
                                    </div>
                                    <div class="row chk-actionrow"><a href="#block5" class="btn okbtn pull-right js-chkopenbtn"
                                                                      data-datagroupheader=".js-chkattekintesdgh">Tovább</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="span10">
                                <div id="block5" class="chk-datagroupheader js-chkdatagroupheader js-chkattekintesdgh"
                                     data-container=".js-chkattekintes">{$sorszam++}. Megrendelés áttekintése
                                </div>
                                <div class="js-chkattekintes js-chkdatacontainer">
                                    ...
                                    <div>
                                        Amennyiben pár percen belül nem kapná meg a megrendelést visszaigazoló emailünket, kérem hívjon minket a 20/342-1511-es
                                        telefonszámon, vagy kérjen visszahívást <a href='mailto:info@mindentkapni.hu'>erre a linkre</a> kattintva, és mi
                                        ellenőrizzük megrendelését.
                                    </div>
                                        ...
                                        <div class="chk-savecontainer">
                                            <div>
                                                <label class="checkbox">
                                                    ...
                                                    Kérjük, a jelölőnégyzetbe helyezett pipával igazolja, hogy elolvasta, megértette, és elfogadta <a
                                                        href="{$showaszflink}" target="empty" class="js-chkaszf">ÁSZF</a>-ünket és adatvédelmi nyilatkozatunkat.
                                            ...
                                            <div><input type="submit" class="btn cartbtn chk-sendorderbtn js-chksendorderbtn" value="Megrendelés elküldése">
                                            </div>
                                        </div>
                                    </div>
                                </div>
