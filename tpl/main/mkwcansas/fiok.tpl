                    ...
                    <div class="tab-content">
                            ...
                            <form id="FiokAdataim" class="form-horizontal" action="/fiok/ment/adataim" method="post">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="VezeteknevEdit" name="vezeteknev" type="text" class="input-medium" placeholder="{t('vezetéknév')}"
                                                   value="{$user.vezeteknev}" required>
                                            <input id="KeresztnevEdit" name="keresztnev" type="text" class="input-medium" placeholder="{t('keresztnév')}"
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <label class="checkbox" for="AkciosHirlevelEdit">{t('Akciókról kérek hírlevelet')}
                                                <input id="AkciosHirlevelEdit" name="akcioshirlevelkell" type="checkbox"
                                                       class="input-large"{if ($user.akcioshirlevelkell)} checked="checked"{/if}>
                                            </label>
                                        </div>
                                        <div class="controls">
                                            <label class="checkbox" for="UjdonsagHirlevelEdit">{t('Újdonságokról kérek hírlevelet')}
                                                <input id="UjdonsagHirlevelEdit" name="ujdonsaghirlevelkell" type="checkbox"
                                                       class="input-large"{if ($user.ujdonsaghirlevelkell)} checked="checked"{/if}>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <form id="FiokSzamlaAdatok" class="form-horizontal" action="/fiok/ment/szamlaadatok" method="post">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="SzamlazasiAdoszamEdit" name="adoszam" type="text" class="input-medium" placeholder="{t('adószám')}"
                                                   value="{$user.adoszam}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="SzamlazasiCimEdit" name="irszam" type="text" class="input-mini" placeholder="{t('ir.szám')}"
                                                   value="{$user.irszam}">
                        ...
                        <div class="tab-pane" id="szallitasiadatok">
                            <div class="acc-copyszamlaadat">
                                <a class="js-copyszamlaadat">Számlázási adatok másolása </a><i
                                    class="icon-question-sign chk-inlinetooltipbtn hidden-phone js-tooltipbtn"
                                    title="Átmásolja az adatokat onnan, felülírja ezeket itt"></i>
                            </div>
                            <form id="FiokSzallitasiAdatok" class="form-horizontal" action="/fiok/ment/szallitasiadatok" method="post">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="SzallitasiNevEdit" name="szallnev" type="text" class="input-xlarge" placeholder="{t('szállítási név')}"
                                                   value="{$user.szallnev}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="SzallitasiCimEdit" name="szallirszam" type="text" class="input-mini" placeholder="{t('ir.szám')}"
                                                   value="{$user.szallirszam}">
                                        ...
                                        <tr class="notvisible acc-megrendelesborderbottom">
                                            <td colspan="6">
                                                ...
                                                <table class="acc-megrendelestetellist">
                                                    ...
                                                    <td>
                                                        <div class="textaligncenter">{t('Termék')}</div>
                                                    </td>
                                                    <td>{t('Megnevezés, cikkszám')}</td>
                                                    <td>
                                                        <div class="textalignright">{t('Egységár')}</div>
                                                    </td>
                                                    <td>
                                                        <div class="textaligncenter">{t('Mennyiség')}</div>
                                                    </td>
                                                    <td>
                                                        <div class="textalignright">{t('Érték')}</div>
                                                    </td>
                                                    </thead>
                                                    <tbody>
                                                    {foreach $megr.tetellista as $tetel}
                                                        <tr class="clickable" data-href="{$tetel.link}">
                                                            <td>
                                                                <div class="textaligncenter"><a href="{$tetel.link}"><img src="{$tetel.kiskepurl}"
                                                                                                                          alt="{$tetel.caption}"
                                                            ...
                                                            <td>
                                                                ...
                                                                {$tetel.cikkszam}</td>
                                                            <td>
                                                                <div class="textalignright">{number_format($tetel.bruttoegysar,0,',',' ')} Ft</div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="textalignright">{number_format($tetel.brutto,0,',',' ')} Ft</div>
                                                            </td>
                                                        </tr>
                                                    {/foreach}
                                                    </tbody>
                        ...
                        <div class="tab-pane" id="termekertesito">
                            {foreach $ertesitok as $ertesito}
                                <div class="row js-termekertesito">
                                    <div class="span1"><a href="/termek/{$ertesito.termek.slug}"><img src="{$ertesito.termek.kiskepurl}"
                                                                                                      alt="{$ertesito.termek.caption}"
                                                                                                      title="{$ertesito.termek.caption}"></a></div>
                                    <div class="span4">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="chk-relative pull-left">
                                                <input id="Jelszo1Edit" name="jelszo1" type="password" class="span" required placeholder="jelszó 1 *"
                                                       data-errormsg1="{t('Adjon meg jelszót.')}" data-errormsg2="{t('A két jelszó nem egyezik.')}">
                                                <i class="icon-question-sign chk-tooltipbtn hidden-phone js-tooltipbtn" title=""
                                                   data-original-title="Jelszó azért szükséges, hogy csak Ön férhessen hozzá személyes adataihoz. Használhat kis- és nagybetűket, valamint számokat is a jelszóban (erősen ajánlott)."></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <div class="controls chk-relative pull-left">
                                            ...
                                            <i class="icon-question-sign chk-tooltipbtn hidden-phone js-tooltipbtn" title=""
                                               data-original-title="Azért kérjük kétszer a jelszót, hogy biztosan elkerülhessük az elgépelést."></i>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <button type="submit" class="btn okbtn">Adatok módosítása</button>
