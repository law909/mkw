...
class TermekOptkeszletRepository extends \mkwhelpers\Repository
{

    public function __construct($em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        parent::__construct($em, $class);
        $this->setEntityname('Entities\TermekOptkeszlet');
    }
    ...
    public function getByTermekIds(array $termekids, $raktarid = null): array
    {
        ...
        $dql = 'SELECT IDENTITY(_xx.termek) AS termekid, IDENTITY(_xx.raktar) AS raktarid,'
            ...
            . ' FROM Entities\TermekOptkeszlet _xx'
            . ' JOIN _xx.termek t'
            . ' WHERE t.id IN (:ids)';
        if ($raktarid) {
     ...
     *
     * @return array [ raktar_id => \Entities\TermekOptkeszlet ]
     */
