...
/**
 * @ORM\Entity(repositoryClass="Entities\TermekMenu2Repository")
 * @ORM\Table(name="termekmenu2",
 * options={"collate"="utf8_hungarian_ci", "charset"="utf8", "engine"="InnoDB"},
 * indexes={
 *      @ORM\index(name="termekmenu2slug_idx",columns={"slug"}),
 *      @ORM\index(name="termekmenu2nevparent_idx",columns={"nev","parent_id"}),
 *      @ORM\index(name="termekmenu2idegenkod_idx",columns={"idegenkod"})
 * })
 */
class TermekMenu2
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="TermekMenu2", mappedBy="parent")
     * @ORM\OrderBy({"sorrend"="ASC","nev"="ASC"})
     */
    private $children;

    /**
     * @ORM\ManyToOne(targetEntity="TermekMenu2", inversedBy="children")
    ...
    /** @ORM\OneToMany(targetEntity="Termek",mappedBy="termekmenu2") */
    private $termekek1;
    ...
    public function addChild(TermekMenu2 $child)
    {
    ...
    public function removeChild(TermekMenu2 $child)
    {
    ...
    public function setParent(TermekMenu2 $parent)
    {
