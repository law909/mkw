...
class JogaBerletRepository extends \mkwhelpers\Repository
{
    ...
    public function __construct($em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        $this->setOrders([
            '1' => ['caption' => 'vásárlás dátum csökkenő', 'order' => ['_xx.nincsfizetve' => 'DESC', '_xx.vasarlasnapja' => 'DESC']],
            '2' => ['caption' => 'név, lejárat dátum csökkenő', 'order' => ['p.nev' => 'ASC', '_xx.lejaratdatum' => 'DESC']]
        ]);
    }
    ...
    public function getAktualisBerlet($partner)
    {
        ...
        $res = $this->getAll($filter, ['vasarlasnapja' => 'DESC']);
        if ($res) {
            return $res[0];
        }
        return null;
