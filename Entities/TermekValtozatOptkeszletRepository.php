...
class TermekValtozatOptkeszletRepository extends \mkwhelpers\Repository
{

    public function __construct($em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        parent::__construct($em, $class);
        $this->setEntityname('Entities\TermekValtozatOptkeszlet');
    }
    ...
    public function getByTermekValtozatIds(array $valtozatids, $raktarid = null): array
    {
        ...
        $dql = 'SELECT IDENTITY(_xx.termekvaltozat) AS valtozatid, IDENTITY(_xx.raktar) AS raktarid,'
            . ' _xx.optkeszlet AS ertek'
            . ' FROM Entities\TermekValtozatOptkeszlet _xx'
     ...
     * @param int[] $valtozatids
     *
     * @return array [ termekvaltozat_id => [ raktar_id => \Entities\TermekValtozatOptkeszlet ] ]
     */
    public function getRowsByTermekValtozatIds(array $valtozatids): array
    {
        ...
        $q = $this->_em->createQuery(
            'SELECT _xx FROM Entities\TermekValtozatOptkeszlet _xx'
            . ' JOIN _xx.termekvaltozat v'
            . ' WHERE v.id IN (:ids)'
        );
        $q->setParameter('ids', $ids);
        /** @var TermekValtozatOptkeszlet $sor */
