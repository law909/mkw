...
if (\mkw\store::isBankpenztar()) {
    ...
    $router->map('GET', '/admin/jelenletiivgen/matrix', 'jelenletiivgenController#createMatrix', 'adminjelenletiivgenmatrix');
...
$router->map('POST', '/admin/setuipref', 'adminController#setUIPref', 'adminsetuipref');
...
$router->map('GET', '/admin/munkalapfej/viewlist', 'munkalapfejController#viewlist', 'adminmunkalapfejviewlist');
$router->map('GET', '/admin/munkalapfej/getlistbody', 'munkalapfejController#getlistbody', 'adminmunkalapfejgetlistbody');
...
$router->map('GET', '/admin/munkalapfej/jarmuadat', 'munkalapfejController#jarmuAdat', 'adminmunkalapfejjarmuadat');
if (!\mkw\store::isClosed()) {
...
$router->map('GET', '/admin/munkalapfej/print', 'munkalapfejController#doPrint', 'adminmunkalapfejprint');
...
if (\mkw\store::isUnas()) {
    ...
    if (!\mkw\store::isClosed()) {
        ...
        $router->map('POST', '/admin/unastermekimport/kategoriak', 'unastermekimportController#importCategories', 'adminunastermekimportkategoriak');
...
$router->map('GET', '/admin/termek/keszletbizonylatok', 'termekController#getKeszletBizonylatok', 'admintermekkeszletbizonylatok');
