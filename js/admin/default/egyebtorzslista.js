$().ready(
        function() {
            ...
            var fizmodgrid = $(_fm.grid).jqGrid({
                ...
                datatype: 'json',
                colModel: [
                    {name: 'id', index: 'id', label: 'Kód', width: 80, fixed: true,
                        editable: false,
                        formoptions: {rowpos: 1, label: 'Kód'}
                    },
                    {name: 'nev', index: 'nev', label: 'Név', width: 160, fixed: true,
                        editable: true,
                        editoptions: {size: 25, maxlength: 255},
                    ...
                    {name: 'webes', index: 'webes', label: 'Webes', width: 25, align: 'center',
                        ...
                        editrules: {},
                        formoptions: {rowpos: 5, label: 'Webes:'}},
                    {name: 'leiras', index: 'leiras', label: 'Leírás', width: 160, fixed: true,
                        editable: true,
                        editoptions: {size: 50},
                        editrules: {required: true},
                    ...
                    {name: 'osztotthaladek1', index: 'osztotthaladek1', label: 'Osztott haladék 1', width: 25, align: 'right',
                        editable: true,
                        editoptions: {integer: true, size: 2},
                        formoptions: {rowpos: 8, label: 'Osztott haladék 1:'}},
                    {name: 'osztottszazalek1', index: 'osztottszazalek1', label: 'Osztott százalék 1', width: 25, align: 'right',
                        editable: true,
                        sorttype: 'float',
                        formatter: 'number',
                        editoptions: {size: 10},
                        formoptions: {rowpos: 9, label: 'Osztott százalék 1:'}},
                    {name: 'osztotthaladek2', index: 'osztotthaladek2', label: 'Osztott haladék 2', width: 25, align: 'right',
                        editable: true,
                        editoptions: {integer: true, size: 2},
                        formoptions: {rowpos: 10, label: 'Osztott haladék 2:'}},
                    {name: 'osztottszazalek2', index: 'osztottszazalek2', label: 'Osztott százalék 2', width: 25, align: 'right',
                        editable: true,
                        sorttype: 'float',
                        formatter: 'number',
                        editoptions: {size: 10},
                        formoptions: {rowpos: 11, label: 'Osztott százalék 2:'}},
                    {name: 'osztotthaladek3', index: 'osztotthaladek3', label: 'Osztott haladék 3', width: 25, align: 'right',
                        editable: true,
                        editoptions: {integer: true, size: 2},
                        formoptions: {rowpos: 12, label: 'Osztott haladék 3:'}},
                    {name: 'osztottszazalek3', index: 'osztottszazalek3', label: 'Osztott százalék 3', width: 25, align: 'right',
                        editable: true,
                        sorttype: 'float',
                        formatter: 'number',
                        editoptions: {size: 10},
                        formoptions: {rowpos: 13, label: 'Osztott százalék 3:'}}
                ],
                rowNum: 100000,
                rowList: [10, 20, 30],
                pager: _fm.pager,
            ...
            var vtszgrid = $(_vtsz.grid).jqGrid({
                ...
                colModel: [
                    ...
                    {name: 'kozvetitett', index: 'kozvetitett', label: 'Közvetített szolg.', width: 25, align: 'center',
                        ...
                        editoptions: {value: '1:0'},
                        editrules: {},
                        formoptions: {rowpos: 4, label: 'Közvetített szolg.:'}}],
                rowNum: 100000,
                rowList: [10, 20, 30],
                pager: _vtsz.pager,
                sortname: 'szam',
            ...
            // Szallitasimod grid
            var _szm = {
                grid: '#szallitasimodgrid',
                pager: '#szallitasimodgridpager'
            };
            var szallitasimodgrid = $(_szm.grid).jqGrid({
                url: '/admin/szallitasimod/jsonlist',
                editurl: '/admin/szallitasimod/save',
                datatype: 'json',
                colModel: [
                    {name: 'nev', index: 'nev', label: 'Név', width: 160, fixed: true,
                        editable: true,
                    ...
                    {name: 'webes', index: 'webes', label: 'Webes', width: 25, align: 'center',
                        ...
                        editoptions: {value: '1:0'},
                        editrules: {},
                        formoptions: {rowpos: 2, label: 'Webes:'}},
                    {name: 'leiras', index: 'leiras', label: 'Leírás', width: 160, fixed: true,
                        editable: true,
                        editoptions: {size: 50},
                        formoptions: {rowpos: 3, label: 'Leírás:'}},
                    ...
                    {name: 'vanszallitasiktg', index: 'vanszallitasiktg', label: 'Van száll.ktg.', width: 25, align: 'center',
                        formatter: 'checkbox',
                        editable: true,
                        edittype: 'checkbox',
                        editoptions: {value: '1:0'},
                        editrules: {},
                        formoptions: {rowpos: 6, label: 'Van száll.ktg.:'}}
                ],
                rowNum: 100000,
                rowList: [10, 20, 30],
                pager: _szm.pager,
                ...
                width: 320,
                hiddengrid: true,
                caption: 'Szállítási módok'});
            $(_szm.grid).jqGrid('navGrid', _szm.pager, {edit: true, add: true, del: true, search: false},
            {reloadAfterSubmit: true, jqModal: false, closeOnEscape: true, bottominfo: _txt.req},
            {reloadAfterSubmit: true, jqModal: false, closeOnEscape: true, bottominfo: _txt.req},
            {reloadAfterSubmit: true});
            $(_szm.grid).jqGrid('navButtonAdd', _szm.pager, {caption: _txt.srch, title: _txt.srchtoggle, buttonicon: _txt.srchicon,
                onClickButton: function() {
                    szallitasimodgrid[0].toggleToolbar();
                }
            });
            $(_szm.grid).jqGrid('navButtonAdd', _szm.pager, {caption: _txt.clr, title: _txt.clrtitle, buttonicon: _txt.clricon,
                onClickButton: function() {
                    szallitasimodgrid[0].clearToolbar();
                }
            });
            $(_szm.grid).jqGrid('filterToolbar');
