$(document).ready(function() {
    ...
    kivet = {
        container: '#mattkarb',
        viewUrl: '/admin/kivetfej/getkarb',
        newWindowUrl: '/admin/kivetfej/viewkarb',
        saveUrl: '/admin/kivetfej/save',
        beforeShow: function() {
        ...
        beforeSerialize: function() {
            return bizonylathelper.checkBizonylatFej('kivet', dialogcenter);
        },
        onSubmit: function() {
            $('#messagecenter')
    ...
    if ($.fn.mattable) {
        ...
        $('#mattable-select').mattable({
            ...
            tablebody: {
                url: '/admin/kivetfej/getlistbody',
                onStyle: function() {
                ...
                onDoEditLink: function() {
                    $('.js-printbizonylat').each(function() {
                        var $this = $(this);
                        $this.attr('href', '/admin/kivetfej/print?id=' + $this.data('egyedid'));
                    });
                }
            },
            karb: kivet
        ...
        if ($.fn.mattkarb) {
            $('#mattkarb').mattkarb($.extend({}, kivet, {independent: true}));
        }
    }
});
