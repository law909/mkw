$(document).ready(function () {
    ...
    $('#mattkarb').mattkarb({
        ...
        beforeShow: function () {
            ...
            $('.js-szinvarimport, .js-szcimkeimport, .js-szeanimport, .js-szmeretimport, .js-szcolorimport, .js-fcmotoorderimport, .js-szinimport, .js-meretimport').on('click', function (e) {
                e.preventDefault();
                var data = new FormData($('#mattkarb-form')[0]);
                $.ajax({
                    type: 'POST',
